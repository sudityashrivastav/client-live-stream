...
, function(e, t, n) {
    var i, r;
    i = [n(6), n(71), n(7), n(51), n(63), n(70), n(2), n(81), n(11), n(9), n(80)],
    r = function(e, t, n, i, r, o, a, s, c, u, l) {
        "use strict";
        function d(t) {
            s.validatePlayerDivId(t),
            this.version = e.NANOPLAYER,
            this.coreversion = "",
            this.viewversion = "",
            this.type = "default",
            this.id = Math.round(1e11 * Math.random()).toString(),
            this._playerDivId = t,
            this._core = null,
            this._view = null,
            this._metrics = null
            ...
            return new Promise(function(e, s) {
                try {
                    var c = l && l.events && l.events.onError ? l.events.onError : null
                      , u = function(e) {
                        e.code || (e.code = _.SETUP.EXCEPTION),
                        e.message || (e.message = "An unknown error occured during setup.");
                        var t = {
                            name: "Error",
                            data: {
                                code: e.code,
                        ...
                        c && this.on(t.name, c),
                        this.emit(t.name, t),
                        this._initView(this._viewConfig),
                        null !== this._view && this._view.handleView(d.states.UNINITIALIZED),
                        s(e)
                    }
                    .bind(this)
                      , l = {};
                    a.extend(n, l),
                    this._bintuConfig = S.create(),
                    this._coreConfig = E.create(),
                    this._viewConfig = v.create(),
                    a.merge(l, this._bintuConfig),
                    a.clean(this._bintuConfig),
                    a.merge(l, this._viewConfig),
                    this.destroy(),
                    l.metrics && (this._metrics = new i,
                    this._metrics.version = this.version,
                    this._metrics.setup(l, this));
                    var f = {};
                    a.extend(n, f),
                    this._checkConfig(f),
                    r.setup(l).then(function(n) {
                        try {
                            a.merge(n, this._viewConfig),
                            a.clean(this._viewConfig),
                            a.merge(n, this._coreConfig),
                            a.clean(this._coreConfig),
                            this._initView(this._viewConfig),
                            this._core = new t(this._playerDivId),
                            this._core.id = this.id,
                            this._corePropagator = o.create(this._core, d.coreEvents, this),
                            this._setPublicListeners(this._coreConfig.events, this),
                            this._connectLayers(),
                            this._core.setup(this._coreConfig).then(function(t) {
                                window.removeEventListener("unload", this.destroy.bind(this)),
                                window.addEventListener("unload", this.destroy.bind(this)),
                                this.coreversion = this._core.version,
                                this.type = this._core.type,
                                this._viewConfig.style && this._viewConfig.style.view && this._view.postSetup(this._core._realPlayer._mediaElementId),
                                a.extend(this._bintuConfig, t),
                                a.extend(this._viewConfig, t),
                                a.clean(t),
                                e(t)
                            }
        ...
        N.destroy = function() {
            ...
            this._core = null,
            this._metrics && this._metrics.destroy(),
            this._metrics = null
        }
        ,
        ...
        N._initView = function(e) {
            !this._view && this._viewConfig.style && this._viewConfig.style.view && (this._view = new n,
            this._view.version = this.version,
            this.viewversion = this._view.version,
            this._view.setBaseValues(this._playerDivId),
            this._view.baseSetup(e),
            this._viewPropagator = o.create(this._view, d.viewEvents, this))
        }
        ,
        ...
        N._connectLayers = function() {
            function e(e, t, n, i) {
                for (var r in e)
                    e.hasOwnProperty(r) && t.indexOf(e[r]) === -1 && n.on(e[r], i.bind(this))
            }
            var t = [d.coreEvents.MEDIA];
            e(d.coreEvents, t, this, this._onCoreEvent.bind(this)),
            e(d.viewEvents, [], this, this._onViewEvent.bind(this))
        }
        ,
        N._onCoreEvent = function(e) {
            if (this._view) {
                if (e.name === d.coreEvents.STATS)
                    return void this._view.handleStats(e.data.stats);
                e.name === d.coreEvents.STATE_CHANGE && this._view.update(e),
                e.name === d.coreEvents.STREAM_INFO && this._view.handleStreamInfo(e),
                e.name === d.coreEvents.STREAM_INFO_UPDATE && this._view.handleStreamInfoUpdate(e),
                e.name !== d.coreEvents.MUTE && e.name !== d.coreEvents.UNMUTE || this._view.handleMute(e.name === d.coreEvents.MUTE),
                e.name === d.coreEvents.VOLUME_CHANGE && this._view.handleVolume(e.data.volume),
                e.name === d.coreEvents.METADATA && this._view.handleMetaData(e)
            }
        }
        ,
        N._onViewEvent = function(e) {
            e.name === d.viewEvents.PLAY ? this._core.play() : e.name === d.viewEvents.PAUSE && this._core.pause(),
            e.name === d.viewEvents.MUTE ? this._core.mute() : e.name === d.viewEvents.UNMUTE && this._core.unmute(),
            e.name === d.viewEvents.VOLUME_CHANGE && this._core.setVolume(e.data.volume)
        }
        ,
        N._callMethod = function() {
            if (!this._core)
                throw new Error('"' + arguments[0] + '" must be implemented or player not initialized by call setup.');
...
, function(e, t, n) {
    ...
    r = function(e, t, n) {
        function i(e, t) {
            var n;
            for (n in e)
                e.hasOwnProperty(n) && t.hasOwnProperty(n) && ("object" != typeof e[n] || !Object.keys(e[n]).length || "object" == typeof t[n] && Object.keys(t[n]).length ? "object" == typeof e[n] ? i(e[n], t[n]) : t[n] = e[n] : r(e[n], t[n]))
        }
        function r(e, t) {
            var n;
            for (n in e)
                e.hasOwnProperty(n) && (!t[n] && (t[n] = {}),
                "object" == typeof e[n] ? r(e[n], t[n]) : t[n] = e[n])
        }
        function o(e) {
            var t;
            for (t in e)
                e.hasOwnProperty(t) && ("undefined" == typeof e[t] || "string" == typeof e[t] && 0 === e[t].length) && delete e[t],
                e.hasOwnProperty(t) && e[t]instanceof Object && o(e[t]);
            for (t in e)
                (e.hasOwnProperty(t) && ("undefined" == typeof e[t] || "string" == typeof e[t] && 0 === e[t].length) || "object" == typeof e[t] && "function" != typeof e[t] && 0 === Object.keys(e[t]).length) && delete e[t]
        }
        function a(e, t, n, i) {
            n = n || "",
            i = i || [];
            var r;
            for (r in e)
                e.hasOwnProperty(r) && t.hasOwnProperty(r) && ("object" == typeof e[r] && "object" == typeof t[r] ? i = a(e[r], t[r], n + r + ".", i) : typeof e[r] !== t[r] && "*" !== t[r] && void 0 !== e[r] && "" !== e[r] && i.push("Configuration warning. The config property '$property$' must be of type '$type$'.".replace("$property$", n + r).replace("$type$", t[r]))),
                e.hasOwnProperty(r) && !t.hasOwnProperty(r) && i.push("Configuration warning. The config property '$property$' is not a valid property. Please remove from config.".replace("$property$", n + r));
            return i
        }
        return {
            merge: i,
...
, function(e, t, n) {
    ...
    r = function() {
        return Object.freeze({
            ...
            CONFIG_WSS: "Configuration error. Could not create player, the websocketsocket server configuration is missing.",
...
, function(e, t, n) {
    var i, r;
    i = [n(9), n(2), n(10), n(11), n(12), n(14), n(15), n(17), n(18), n(19), n(20), n(8), n(21), n(22), n(23), n(24), n(25), n(26), n(31), n(36), n(38), n(43)],
    r = function(e, t, n, i, r, o, a, s, c, u, l, d, f, h, E, p, m, _, T, y, v, g) {
        "use strict";
        function S() {
            this.version = ""
        }
        ...
        return A.setBaseValues = function(e) {
            this.config = a.create(),
            this._playerDivId = e,
            this._emitter = new i,
            this._muted = !1,
            this._handleAutoplay = !1,
            this._isRestarting = !1,
            this.state = u.IDLE
        }
        ,
        A.baseSetup = function(e) {
            t.merge(e, this.config),
            t.clean(this.config),
            this.config.style.view && (this.registerExternalEventHandler(),
            this._style = _.create(this._emitter, this._playerDivId, this.config.style),
            this.config.style.audioPlayer || (this.config.style.fullScreenControl && (this._fullscreen = v.create(this._playerDivId, this._emitter)),
            this._middleView = T.create(this._playerDivId),
            this._resizeListener = c.create(this._playerDivId, this._emitter))),
            this.config.style.controls && (this._controls = g.create(this._playerDivId, this._emitter, this.config)),
            this._handleAutoplay = this.config.playback.autoplay
        }
        ,
        A.postSetup = function(e) {
            this._mediaElementId = e,
            this._mediaElement = this.getMediaElement(),
            this.config.style.view && this._style.update(this._mediaElement),
            this.config.style.interactive && !this.config.style.audioPlayer ? (this._interactive = m.create(this._playerDivId, this._mediaElement, this._emitter),
            this._interactive.update(this.state)) : this.config.style.controls && this._controls.show(),
        ...
        A.registerExternalEventHandler = function() {
            for (var e in d)
                d.hasOwnProperty(e) && this._emitter.on(d[e], this._emit.bind(this, d[e]))
        }
        ,
        A.registerInternalEventHandler = function() {
            ...
            .bind(this)),
            this._emitter.on(h.AUDIO_SINGLE_CLICK, function(e) {
                this._muted ? this._emitter.emit(d.UNMUTE) : this._emitter.emit(d.MUTE)
            }
            .bind(this)),
            this._emitter.on(h.PLAYER_SINGLE_CLICK, function(e) {
            ...
            this._controls) {
                ...
                for (var t in E)
                    E.hasOwnProperty(t) && d.hasOwnProperty(t) && (e.indexOf(E[t]) === -1 ? this._emitter.on(E[t], this._emitter.emit.bind(this._emitter, d[t])) : this._fullscreen && this._emitter.on(E[t], function(e) {
            ...
            if (this._fullscreen)
                for (var t in f)
                    f.hasOwnProperty(t) && (this._emitter.on(f[t], function(e) {
                        this.handleFullscreen(e && e === f.FULLSCREEN_ENTER)
                    }
                    .bind(this).bind(this, f[t])),
                    this._emitter.on(f[t], this._emitter.emit.bind(this._emitter, d[t])));
        ...
        A.removeExternalEventHandler = function() {
            if (this._emitter)
                for (var e in d)
                    d.hasOwnProperty(e) && this._emitter.removeAllListeners(d[e])
        }
        ,
        A.removeInternalEventHandler = function() {
            if (this._emitter) {
                if (this._interactive && (this._emitter.removeAllListeners(h.PLAYER_SINGLE_CLICK),
                this._emitter.removeAllListeners(h.PLAYBUTTON_SINGLE_CLICK),
                this._emitter.removeAllListeners(h.AUDIO_SINGLE_CLICK)),
                this._controls)
                    for (var e in E)
                        E.hasOwnProperty(e) && d.hasOwnProperty(e) && this._emitter.removeAllListeners(E[e]);
                if (this._fullscreen)
                    for (var e in f)
                        f.hasOwnProperty(e) && this._emitter.removeAllListeners(f[e]);
        ...
        A.update = function(e) {
            this.state = e.state,
            this._emitter.emit(o.STATE_CHANGE, e),
            this.handleView(e.state),
            this._interactive && this._interactive.update(e.state)
        }
        ,
        A.handleView = function(e) {
            switch (this._viewTimeout && clearTimeout(this._viewTimeout),
            e) {
            ...
            case u.IDLE:
                ...
                break;
            case u.READY:
                this._middleView && this._middleView.update(p.PLAYBUTTON),
                this._controls && this._controls.play();
                break;
            case u.LOADING:
                this._middleView && this._middleView.update(p.LOADING),
            ...
            case u.PLAYING:
                ...
                break;
            case u.PAUSED:
                this._isRestarting || (this._middleView && this._middleView.update(p.PLAYBUTTON),
                this._controls && this._controls.play()),
                this._isRestarting = !1;
                break;
            case u.BUFFERING:
        ...
        A.handleStreamInfo = function(e) {
            this._emitter.emit(o.STREAM_INFO, e),
            this.progressStreamInfo(e)
        }
        ,
        A.handleStreamInfoUpdate = function(e) {
            this._emitter.emit(o.STREAM_INFO_UPDATE, e),
            this.progressStreamInfo(e)
        }
        ,
        A.progressStreamInfo = function(e) {
            this.streamInfo = e.data.streamInfo,
            this._scaling && this._scaling.destroy() && (this._scaling = null),
            this.streamInfo.haveVideo && (this._scaling = y.create(this._playerDivId, this._mediaElement, this.streamInfo.videoInfo, this.config.style.scaling))
        }
        ,
        ...
        A.handleMute = function(e) {
            this._controls && (e ? this._controls.mute() : this._controls.unmute()),
            this._muted = e,
            this.handleAudio()
        }
        ,
        ...
        A._emit = function(e, t) {
            var n = {};
            t && t.name && t.data ? n = t : t ? (n.data = t,
            n.name = e || "unknown") : (n.data = {},
            n.name = e || "unknown"),
            n.player = this._playerDivId,
            n.state = this.state,
            this.emit(n.name, n)
        }
        ,
...
, function(e, t, n) {
    ...
    r = function() {
        ...
        var r, o, a, s = navigator.appVersion, c = navigator.userAgent, u = navigator.appName, l = "" + parseFloat(navigator.appVersion), d = parseInt(navigator.appVersion, 10);
        (o = c.indexOf("Opera")) !== -1 && (u = "Opera",
        l = c.substring(o + 6),
        (o = c.indexOf("Version")) !== -1 && (l = c.substring(o + 8))),
        (o = c.indexOf("OPR/")) !== -1 ? (u = "Opera",
        l = c.substring(o + 4)) : (o = c.indexOf("MSIE")) !== -1 ? (u = "Microsoft Internet Explorer",
        l = c.substring(o + 5)) : "Netscape" === u && (o = c.indexOf("Trident/")) !== -1 ? (u = "Microsoft Internet Explorer",
        l = c.substring(o + 8),
        (o = c.indexOf("rv:")) !== -1 && (l = c.substring(o + 3))) : "Netscape" === u && (o = c.indexOf("Edge/")) !== -1 ? (u = "Microsoft Edge",
        l = c.substring(o + 5)) : (o = c.indexOf("Chrome")) !== -1 ? (u = "Chrome",
        l = c.substring(o + 7)) : (o = c.indexOf("PhantomJS")) !== -1 ? (u = "PhantomJS",
        l = c.substring(o + 10)) : (o = c.indexOf("Safari")) !== -1 ? (u = "Safari",
        l = c.substring(o + 7),
        (o = c.indexOf("Version")) !== -1 && (l = c.substring(o + 8)),
        c.indexOf("CriOS") !== -1 && (u = "Chrome")) : (o = c.indexOf("Firefox")) !== -1 ? (u = "Firefox",
        l = c.substring(o + 8)) : (r = c.lastIndexOf(" ") + 1) < (o = c.lastIndexOf("/")) && (u = c.substring(r, o),
        l = c.substring(o + 1),
        u.toLowerCase() === u.toUpperCase() && (u = navigator.appName)),
        (a = l.indexOf(";")) !== -1 && (l = l.substring(0, a)),
        (a = l.indexOf(" ")) !== -1 && (l = l.substring(0, a)),
        (a = l.indexOf(")")) !== -1 && (l = l.substring(0, a)),
        d = parseInt("" + l, 10),
        isNaN(d) && (l = "" + parseFloat(navigator.appVersion),
        d = parseInt(navigator.appVersion, 10));
        var f = /Mobile|mini|Fennec|Android|iP(ad|od|hone)/.test(s)
          , h = !!navigator.cookieEnabled;
        "undefined" != typeof navigator.cookieEnabled || h || (document.cookie = "testcookie",
        h = document.cookie.indexOf("testcookie") !== -1);
        var E = e
          , p = [{
            s: "Windows 3.11",
            r: /Win16/
        ...
        var T = e;
        switch (/Windows/.test(E) && (/Windows (.*)/.exec(E) && (T = /Windows (.*)/.exec(E)[1]),
        E = "Windows"),
        E) {
        case "Mac OS X":
                    ...
                    if ("" !== t)
                        for (var i = t.split("&"), r = 0; r < i.length; ++r) {
                            var a = ""
                              ...
                              , c = s[0];
                            s.length > 1 && (a = s[1]),
                            o[decodeURIComponent(c)] = decodeURIComponent(a)
                        }
                }
                try {
                    return o[e]
...
, function(e, t, n) {
    ...
    r = function() {
        ...
        i.addListener = function(e, n) {
            ...
            for (i in r)
                r.hasOwnProperty(i) && t(r[i], n) === -1 && r[i].push(o ? n : {
                    listener: n,
                    once: !1
                });
            return this
...
, function(e, t, n) {
    ...
    r = function(e, t) {
        ...
        for (var y in T)
            T.hasOwnProperty(y) && n.debug(y + ": " + T[y]);
        return T
    }
    .apply(t, i),
    !(void 0 !== r && (e.exports = r))
...
, function(e, t, n) {
    ...
    r = function(e) {
        ...
        function t(t, n) {
            function i() {
                !o || o.clientWidth === a && o.clientHeight === s || (a = o.clientWidth,
                s = o.clientHeight,
                u.emit(e.PLAYER_RESIZE, {
                    width: a,
                    height: s,
                    aspectratio: a / s
                }))
...
, function(e, t, n) {
    var i, r;
    i = [n(9), n(22), n(8), n(20), n(19)],
    r = function(e, t, n, i, r) {
        "use strict";
        function o(e, n, r) {
            function o() {
                f.addEventListener(i.CLICK, c),
                n.addEventListener(i.CLICK, c),
                n.addEventListener("contextmenu", u)
            }
            function a() {
                f && f.removeEventListener(i.CLICK, c),
                n && (n.removeEventListener(i.CLICK, c),
                n.removeEventListener("contextmenu", u))
            }
            function s(t) {
                d = t;
                var n = document.getElementById("middleView-" + e);
                n && n.firstChild && (n.firstChild.addEventListener(i.CLICK, c),
                a(),
                setTimeout(o, 200))
            }
            function c(e) {
                ...
                e.target.id && e.target.id.indexOf("controls-") !== -1 || e.button && 0 !== e.button || h.touchInProgress || (h.touchInProgress = !0,
                e.target.id && e.target.id.indexOf("playButton-") !== -1 ? r.emit(t.PLAYBUTTON_SINGLE_CLICK) : e.target.id && e.target.id.indexOf("audio-") !== -1 ? r.emit(t.AUDIO_SINGLE_CLICK) : r.emit(t.PLAYER_SINGLE_CLICK),
            ...
            var d, f = document.getElementById(e), h = {
                timeout: 0,
                touchInProgress: !1
            };
            return {
...
, function(e, t, n) {
    var i, r;
    i = [n(9), n(27), n(14), n(28), n(29)],
    r = function(e, t, n, i, r) {
        "use strict";
        function o(o, a, s) {
            function c(t) {
                h = document.getElementById(a);
                var n, i, r, o, s, c = ["width", "height"], u = 0;
                "auto" !== t.width && "auto" !== t.height ? t.audioPlayer ? t.width && t.height ? (h.style.width = t.width,
                h.style.height = t.height) : t.width ? (h.style.width = t.width,
                h.style.height = Math.round(e.mobile ? 100 / 6 : 100 / 12) / 100 * h.clientWidth + "px") : h.clientWidth || h.clientHeight ? h.clientWidth && (h.style.height = Math.round(e.mobile ? 100 / 6 : 100 / 12) / 100 * h.clientWidth + "px") : (h.style.width = "640px",
                h.style.height = Math.round(e.mobile ? 100 / 6 : 100 / 12) / 100 * h.clientWidth + "px") : t.width && t.height ? (h.style.width = t.width,
                h.style.height = t.height) : (t.width || t.height) && t.aspectratio ? (u = +!!t.height,
                r = t[c[u]].indexOf("%") !== -1,
                o = t[c[u]].indexOf("px") !== -1,
                h.style[c[u]] = t[c[u]],
                s = t.aspectratio.split("/"),
                s[0] = parseInt(s[0]),
                s[1] = parseInt(s[1]),
                (r || o) && (n = parseInt(t[c[u]].replace(r ? "%" : "px", "")),
                i = Math.round(n * s[+!u] / s[u]).toString() + (r ? "%" : "px"),
                h.style[c[+!u]] = i)) : (t.width || t.height) && (t.width || t.aspectratio) && (t.aspectratio || t.height) || h.clientWidth && h.clientHeight || (h.style.width = "640px",
                h.style.height = "360px") : h.clientWidth || h.clientHeight ? h.clientWidth || "auto" !== t.width ? h.clientHeight || (t.aspectratio && !t.audioPlayer ? (s = t.aspectratio.split("/"),
                s[0] = parseInt(s[0]),
                s[1] = parseInt(s[1]),
                h.style.height = Math.round(h.clientWidth / s[0] * s[1]).toString() + "px") : h.style.height = t.audioPlayer ? Math.round(e.mobile ? 100 / 6 : 100 / 12) / 100 * h.clientWidth + "px" : Math.round(h.clientWidth / 16 * 9).toString() + "px") : t.aspectratio ? (s = t.aspectratio.split("/"),
                s[0] = parseInt(s[0]),
                s[1] = parseInt(s[1]),
                h.style.width = Math.round(h.clientHeight * s[0] / s[1]).toString() + "px") : h.style.width = Math.round(16 * h.clientHeight / 9).toString() + "px" : (h.style.width = "640px",
                h.style.height = t.audioPlayer ? Math.round(e.mobile ? 100 / 6 : 100 / 12) / 100 * h.clientWidth + "px" : "360px"),
                h.style.overflow = "hidden",
                h.style.position = "relative",
                h.style.backgroundColor = t.audioPlayer ? "transparent" : t.backgroundColor ? t.backgroundColor : "black"
            }
            function u(e) {
                p = e,
                p && (!_ && r.add({
                ...
                p.style.backgroundColor = s.audioPlayer ? "transparent" : s.backgroundColor ? s.backgroundColor : "black",
                t.normalize(p, "transform", "translate(-50%, -50%)"))
            }
            function l() {
                return r.remove({
                    target: o,
            ...
            function d(e) {
                E = e.state,
                s.audioPlayer ? p.style.visibility = "hidden" : E == i.READY ? !s.keepFrame && (p.style.visibility = "hidden") : E == i.PAUSED ? !s.keepFrame && (p.style.visibility = "hidden") : E == i.PLAYING && !s.keepFrame && (p.style.visibility = "visible")
            }
            function f(e) {
...
, function(e, t, n) {
    ...
    r = function(e) {
        ...
        function t(t) {
            if (!t.target)
                throw new Error(e.NO_TARGET);
            if (!t.listeners || !t.listeners.length)
                throw new Error(e.NO_LISTENERS);
            if (!n(t.target, o) || !n(t.target, a))
                throw new Error(e.NOT_DISPATCHER);
            for (var i = 0; i < t.listeners.length; ++i)
                if (!t.listeners[i].type && "string" != typeof t.listeners[i].type || 0 !== t.listeners[i].type.length) {
                    if (!t.listeners[i].type)
                        throw new Error(e.MISSING_TYPE.replace("%index%", i));
        ...
        function i(e, i) {
            t(i),
            r(n(i.target, e), i.target, i.listeners)
        }
        function r(e, t, n) {
            for (var i = 0; i < n.length; ++i)
                e.call(t, n[i].type, n[i].listener)
        }
...
, function(e, t, n) {
    var i, r;
    i = [n(27), n(24), n(32), n(33), n(34), n(35)],
        ...
        function a(a) {
            function s() {
                if (!document.getElementById(p)) {
                    ...
                    e.normalize(m, "transform", "translate(-50%, -50%)"),
                    m.style.zIndex = 1e3,
                    E.appendChild(m)
                }
            }
...
, function(e, t, n) {
    ...
    r = function() {
        ...
        function e(e, t, n) {
            function i() {
                var e = n();
                for ((t.style.width = e.width + "px") && (o.width = t.clientWidth),
                (t.style.height = e.height + "px") && (o.height = t.clientHeight),
                a.xCenter = o.width / 2,
                a.yCenter = o.height / 2,
                a.radius = o.width / 3,
                a.startSize = a.radius / 3,
                a.num++,
                a.ctx.clearRect(0, 0, 2 * a.xCenter, 2 * a.yCenter),
                a.i = 0; a.i < 9; a.i++)
                    a.ctx.beginPath(),
                    a.ctx.fillStyle = "rgba(255,255,255," + .1 * a.i + ")",
                    a.angle = a.pi * a.i * .25,
                    a.posX[a.i] = a.xCenter + a.radius * Math.cos(a.angle),
                    a.posY[a.i] = a.yCenter + a.radius * Math.sin(a.angle),
                    a.ctx.arc(a.posX[(a.i + a.num) % 8], a.posY[(a.i + a.num) % 8], a.startSize / 9 * a.i, 0, 2 * a.pi, 1),
                    a.ctx.fill()
            }
            function r() {
                return a.interval && clearInterval(a.interval),
                a.interval = 0,
                a.ctx && a.ctx.clearRect(0, 0, o.width, o.height),
...
, function(e, t, n) {
    ...
    r = function() {
        ...
        function e(e, t, n) {
            function i() {
                var e = n();
                (t.style.width = e.width + "px") && (o.width = t.clientWidth),
                (t.style.height = e.height + "px") && (o.height = t.clientHeight);
                var i = o.width;
                a.ctx.beginPath(),
                a.ctx.fillStyle = "transparent",
                a.ctx.arc(.5 * i, .5 * i, .45 * i, 0, 2 * Math.PI),
                a.ctx.fill(),
                a.ctx.lineWidth = .05 * i,
                a.ctx.strokeStyle = "rgba(255,255,255,0.7)",
                a.ctx.stroke(),
                a.ctx.fillStyle = "rgba(255,255,255,0.7)",
                a.ctx.beginPath(),
                a.ctx.moveTo(.35 * i, .25 * i),
                a.ctx.lineTo(.35 * i, .75 * i),
                a.ctx.lineTo(.75 * i, .5 * i),
                a.ctx.fill()
            }
            function r() {
                return a.ctx && a.ctx.clearRect(0, 0, o.width, o.height),
                o.parentElement === t && t.removeChild(o),
                o = null,
                null
            }
        ...
        function e(e, t, n) {
            function i() {
                ...
                var i = o.width
                  ...
                  , f = .05 * i;
                a.ctx.beginPath(),
                a.ctx.moveTo(c + r / 2, c),
                a.ctx.lineTo(c + r, s + c),
                a.ctx.lineTo(c, s + c),
                a.ctx.closePath();
                ...
                a.ctx.fillStyle = h,
                a.ctx.fill(),
                h = a.ctx.createLinearGradient(0, c, 0, c + s),
                h.addColorStop(0, "transparent"),
                h.addColorStop(.5, "transparent"),
                h.addColorStop(.5, d),
                h.addColorStop(1, l),
                a.ctx.fillStyle = h,
                a.ctx.fill(),
                a.ctx.lineWidth = f,
                a.ctx.lineJoin = "round",
                a.ctx.strokeStyle = "#333",
                a.ctx.stroke(),
                a.ctx.textAlign = "center",
                a.ctx.textBaseline = "middle",
                a.ctx.font = "bold " + Math.round(s / 1.3) + 'px "Times New Roman", Times, serif',
                a.ctx.fillStyle = "#333";
                try {
...
, function(e, t, n) {
    ...
    r = function() {
        ...
        function e(e, t, n, i) {
            function r() {
                var e = n();
                (t.style.width = e.width + "px") && (f.width = t.clientWidth),
                (t.style.height = e.height + "px") && (f.height = t.clientHeight);
                var r = E.ctx
                  , a = f.width
                  , p = {
                    l175: o(.175 * a),
                ...
                r.lineJoin = "round",
                r.moveTo(p.l20, p.l37),
                r.lineTo(p.l20, p.l63),
                r.lineTo(p.l30, p.l63),
                r.lineTo(p.l50, p.l825),
                r.lineTo(p.l50, p.l175),
                r.lineTo(p.l30, p.l37),
                r.fill(),
                r.lineWidth = o(.1 * a),
                r.lineCap = "round",
                i && (r.strokeStyle = "rgba(255,255,255,0.2)"),
                s = c = f.width / 2,
                u = .3 * a,
                l = 1.6 * Math.PI,
                d = .4 * Math.PI,
            ...
            function a() {
                return E.ctx && E.ctx.clearRect(0, 0, f.width, f.height),
                f.parentElement === t && t.removeChild(f),
                f = null,
                null
            }
            var s, c, u, l, d, f = document.createElement("canvas"), h = !1, E = {
                id: "audio-" + e,
                ctx: f.getContext("2d")
            };
            return f.id = E.id,
        ...
        function n(n, i, r, o) {
            ...
            function s(t) {
                if (i) {
                    ...
                    switch (o) {
                    case "letterbox":
                        t % 180 && (f = (f / d).toFixed(2),
                        h = (h / d).toFixed(2));
                        break;
                    case "crop":
                        u < 0 ? (h = (n.height / (n.width / d)).toFixed(2),
                        f = h) : u >= 0 && (f = (n.width / (n.height * d)).toFixed(2),
                        h = f),
                        t % 180 && (f = (f * u).toFixed(2),
                        h = (h * u).toFixed(2));
                        break;
                    case "fill":
                    ...
                    case "original":
                        ...
                        break;
                    case "resize":
                        "fixed" !== l.style.position && (s[0] = r.width + "px",
                        s[1] = r.height + "px",
                        l.style.width = s[0],
                        l.style.height = s[1])
                    }
                    e.normalize(i, "transform", "translate(-50%, -50%) scaleX(" + f + ") scaleY(" + h + ") rotate(" + t + "deg)"),
                    i.style.width = s[0],
                    i.style.height = s[1]
                }
            }
...
, function(e, t, n) {
    ...
    r = function(e, t, n) {
        ...
        function i(i, r) {
            function o() {
                for (var e in t)
                    t.hasOwnProperty(e) && (document.addEventListener(t[e], s),
                    document.addEventListener(t[e].toLowerCase(), s))
            }
            function a() {
                for (var e in t)
                    t.hasOwnProperty(e) && (document.removeEventListener(t[e], s),
                    document.removeEventListener(t[e].toLowerCase(), s))
            }
            function s(t) {
                c() ? (h.style.width = "100vw",
                h.style.height = "100vh",
                E = e.ENTERED,
                r.emit(n.FULLSCREEN_ENTER)) : (E = e.EXITED,
                r.emit(n.FULLSCREEN_EXIT),
                h.style.cssText = p)
            }
            function c() {
                var e = u();
            ...
            var h = document.getElementById(i)
              , E = e.EXITED;
            h.requestFullScreen = h.requestFullscreen || h.mozRequestFullScreen || h.webkitRequestFullscreen || h.msRequestFullscreen,
...
, function(e, t, n) {
    ...
    r = function(e, t, n) {
        ...
        function i(e, i) {
                ...
                try {
                    if (o()) {
                        ...
                        for (var e = 0; e < _.length; e += 1)
                            _[e].element.style.cssText = _[e].cssText,
                            _[e].border && (_[e].element.frameBorder = _[e].border);
                        for (; _.length; )
                            _.pop();
                        v = g = null,
                        E = t.EXITED,
                        i.emit(n.FULLSCREEN_EXIT)
                    } else {
                        _.unshift({
                            window: window,
                        ...
                        m = setInterval(u, 300);
                        for (var e = 0; e < _.length; e += 1)
                            _[e].element.style.position = "fixed",
                            _[e].element.style.left = 0,
                            _[e].element.style.top = 0,
                            _[e].border && (_[e].element.frameBorder = "0");
                        s(),
                        E = t.ENTERED,
                        i.emit(n.FULLSCREEN_ENTER)
                    }
                } catch (e) {}
            }
            function s() {
            ...
            function c(e) {
                !g && (g = _[0]),
                T = g.document.documentElement.clientWidth / g.window.innerWidth,
                y = (0 === g.window.orientation ? g.window.screen.height : g.window.screen.width) - g.window.innerWidth * T,
                y = y > 1 && !p ? y : 0,
                e.element.style.width = g.window.innerWidth * T + "px",
                e.element.style.height = g.window.innerHeight * T - y + "px"
            }
            function u() {
                try {
                    o() && s()
...
, function(e, t, n) {
    var i, r;
    i = [n(9), n(20), n(45), n(46), n(40), n(44), n(47), n(48), n(49), n(50)],
    r = function(e, t, n, i, r, o, a, s, c, u) {
        "use strict";
        function l(l, d, f) {
            function h() {
            ...
            function p() {
                document.getElementById(b) || (P.id = b,
                P.style.width = "100%",
                P.style.height = (w ? "100" : Math.round(e.mobile ? 100 / 6 : 100 / 12)) + "%",
                P.style.maxHeight = C.clientWidth / 8 + "px",
                P.style.position = "absolute",
                P.style.left = "0",
                P.style.bottom = "0",
                P.style.zIndex = 2352346258378,
                P.style.backgroundColor = w ? "white" : "rgba(255,255,255,0.7)",
                !w && E(),
                C.appendChild(P),
                U.playPauseControl = o.create(P, d),
                U.timeControl = u.create(P, d),
                !w && L && (U.fullscreenControl = c.create(P, d)),
                U.volumeControl = s.create(P, d, w),
                U.muteControl = a.create(P, d, w),
                !w && C.addEventListener(t.MOUSE_MOVE, T, !0))
            }
            function m() {
                P.style.zIndex = 2352346258378
            }
            function _() {
                ...
                P.style.height = (w ? "100" : Math.min(t, n)) + "px",
                P.style.maxHeight = C.clientWidth / 8 + "px";
                for (var i in U)
                    U[i].update && U[i].update()
            }
            function T(e) {
            ...
            function S(e) {
                !w && L && (m(),
                e ? U.fullscreenControl.update(r.ENTERED) : U.fullscreenControl.update(r.EXITED))
            }
            function A() {
            ...
            function O() {
                D && clearTimeout(D);
                for (var e in U)
                    "undefined" != typeof U[e] && U[e].destroy(),
                    delete U[e];
                return w && C.removeEventListener(t.MOUSE_MOVE, T),
                P && P.parentElement === C && C.removeChild(P),
                P = null,
                C = null,
                null
            }
...
, function(e, t, n) {
    var i, r;
    i = [n(9), n(20), n(23), n(45)],
    r = function(e, t, n, i) {
        "use strict";
        function r(r, o) {
            function a() {
                h.ctx && h.ctx.clearRect(0, 0, d.width, d.height),
                d.width = d.height = r.clientHeight;
                var e = d.width
                  , t = {
                    l20: s(.2 * e),
                    l30: s(.3 * e),
                ...
                f === i.PLAY ? (h.ctx.beginPath(),
                h.ctx.fillStyle = "rgba(0,0,0,1)",
                h.ctx.moveTo(t.l30, t.l20),
                h.ctx.lineTo(t.l30, t.l80),
                h.ctx.lineTo(t.l75, t.l50),
                h.ctx.fill()) : f === i.PAUSE && (h.ctx.beginPath(),
                h.ctx.fillStyle = "rgba(0,0,0,1)",
                h.ctx.moveTo(t.l30, t.l20),
                h.ctx.lineTo(t.l30, t.l80),
                h.ctx.lineTo(t.l45, t.l80),
                h.ctx.lineTo(t.l45, t.l20),
                h.ctx.moveTo(t.l55, t.l20),
                h.ctx.lineTo(t.l55, t.l80),
                h.ctx.lineTo(t.l70, t.l80),
                h.ctx.lineTo(t.l70, t.l20),
                h.ctx.fill())
            }
            function s(e) {
                return Math.floor(e)
            ...
            function u() {
                h.ctx && h.ctx.clearRect(0, 0, d.width, d.height),
                d && d.parentElement === r && r.removeChild(d),
                d = null
            }
            function l(e) {
            ...
            d.addEventListener(e.mobile ? t.TOUCH_END : t.MOUSE_UP, l),
            r.appendChild(d),
            a(),
            {
                update: c,
...
, function(e, t, n) {
    var i, r;
    i = [n(9), n(20), n(23), n(46)],
    r = function(e, t, n, i) {
        "use strict";
        function r(r, o, a) {
            function s() {
                v.ctx && v.ctx.clearRect(0, 0, _.width, _.height),
                _.width = _.height = r.clientHeight;
                var e = _.width
                  , t = {
                    l175: c(.175 * e),
                    l20: c(.2 * e),
                ...
                v.ctx.beginPath(),
                v.ctx.fillStyle = "rgba(0,0,0,1)",
                v.ctx.strokeStyle = "rgba(0,0,0,1)",
                v.ctx.lineJoin = "round",
                v.ctx.moveTo(t.l20, t.l37),
                v.ctx.lineTo(t.l20, t.l63),
                v.ctx.lineTo(t.l30, t.l63),
                v.ctx.lineTo(t.l50, t.l825),
                v.ctx.lineTo(t.l50, t.l175),
                v.ctx.lineTo(t.l30, t.l37),
                v.ctx.fill(),
                v.ctx.lineWidth = c(.1 * e),
                v.ctx.lineCap = "round",
                T === i.MUTED && (v.ctx.strokeStyle = "rgba(0,0,0,0.2)"),
                f = h = _.width / 2,
                E = .3 * e,
                p = 1.6 * Math.PI,
                m = .4 * Math.PI,
                v.ctx.beginPath(),
                v.ctx.arc(f, h, E, p, m, y),
                v.ctx.stroke(),
                E = .15 * e,
                p = 1.7 * Math.PI,
                m = .3 * Math.PI,
            ...
            function l() {
                v.ctx && v.ctx.clearRect(0, 0, _.width, _.height),
                _ && _.parentElement === r && r.removeChild(_),
                _ = null
            }
            function d(e) {
                T === i.MUTED ? o.emit(n.UNMUTE) : T === i.UNMUTED && o.emit(n.MUTE)
            }
            var f, h, E, p, m, _ = document.createElement("canvas"), T = i.UNMUTED, y = !1, v = {
                id: "mute-" + r.id,
                ctx: _.getContext("2d")
            };
            return _.id = v.id,
            ...
            _.addEventListener(e.mobile ? t.TOUCH_END : t.MOUSE_UP, d),
            r.appendChild(_),
            s(),
            {
                update: u,
...
, function(e, t, n) {
    ...
    r = function(e, t, n, i) {
        ...
        function r(i, r, o) {
            function a() {
                S.ctx && S.ctx.clearRect(0, 0, y.width, y.height),
                y.height = i.clientHeight,
                y.width = 3 * y.height,
                d = y.width,
                f = y.height,
                S.ctx.beginPath(),
                ...
                S.ctx.lineTo(p, E),
                S.ctx.lineTo(p, m),
                S.ctx.fillStyle = "rgba(0,0,0,0.2)",
                S.ctx.fill(),
                S.value && (S.ctx.closePath(),
                S.ctx.beginPath(),
                _ = s(h + S.value * (p - h)),
                T = s(E - S.value * (E - m)),
                S.ctx.moveTo(h, E),
            ...
            function u() {
                S.ctx && S.ctx.clearRect(0, 0, y.width, y.height),
                y && y.parentElement === i && i.removeChild(y),
                y = null
            }
            function l(e) {
                var t = e.target || e.srcElement
                  ...
                  , l = ((e.clientY ? e.clientY : c.clientY) - a - s.top,
                0);
            ...
            var d, f, h, E, p, m, _, T, y = document.createElement("canvas"), v = .1, g = .15, S = {
                id: "volume-" + i.id,
                ctx: y.getContext("2d"),
                value: 1
            };
            ...
            y.addEventListener(e.mobile ? t.TOUCH_END : t.MOUSE_UP, l),
            i.appendChild(y),
            a(),
            {
                update: c,
...
, function(e, t, n) {
    var i, r;
    i = [n(9), n(20), n(23), n(40)],
    r = function(e, t, n, i) {
        "use strict";
        function r(r, o) {
            function a() {
                E.ctx && E.ctx.clearRect(0, 0, f.width, f.height),
                f.width = f.height = r.clientHeight;
                var e = f.width
                  , t = {
                    l20: s(.2 * e),
                    l35: s(.35 * e),
                ...
                E.ctx.beginPath(),
                E.ctx.strokeStyle = "rgba(0,0,0,1)",
                E.ctx.lineCap = "round",
                E.ctx.lineWidth = c(.1 * e),
                h === i.ENTERED ? (E.ctx.beginPath(),
                E.ctx.moveTo(t.l20, t.l35),
                E.ctx.lineTo(t.l35, t.l35),
                E.ctx.lineTo(t.l35, t.l20),
                E.ctx.stroke(),
                E.ctx.beginPath(),
                E.ctx.moveTo(t.l65, t.l20),
                E.ctx.lineTo(t.l65, t.l35),
                E.ctx.lineTo(t.l80, t.l35),
                E.ctx.stroke(),
                E.ctx.beginPath(),
                E.ctx.moveTo(t.l80, t.l65),
                E.ctx.lineTo(t.l65, t.l65),
                E.ctx.lineTo(t.l65, t.l80),
                E.ctx.stroke(),
                E.ctx.beginPath(),
                E.ctx.moveTo(t.l35, t.l80),
                E.ctx.lineTo(t.l35, t.l65),
                E.ctx.lineTo(t.l20, t.l65),
                E.ctx.stroke()) : h === i.EXITED && (E.ctx.beginPath(),
                E.ctx.moveTo(t.l20, t.l35),
                E.ctx.lineTo(t.l20, t.l20),
                E.ctx.lineTo(t.l35, t.l20),
                E.ctx.stroke(),
                E.ctx.beginPath(),
                E.ctx.moveTo(t.l65, t.l20),
                E.ctx.lineTo(t.l80, t.l20),
                E.ctx.lineTo(t.l80, t.l35),
                E.ctx.stroke(),
                E.ctx.beginPath(),
                E.ctx.moveTo(t.l80, t.l65),
                E.ctx.lineTo(t.l80, t.l80),
                E.ctx.lineTo(t.l65, t.l80),
                E.ctx.stroke(),
                E.ctx.beginPath(),
                E.ctx.moveTo(t.l35, t.l80),
                E.ctx.lineTo(t.l20, t.l80),
                E.ctx.lineTo(t.l20, t.l65),
                E.ctx.stroke(),
                E.ctx.stroke())
            }
            ...
            function l() {
                E.ctx && E.ctx.clearRect(0, 0, f.width, f.height),
                f && f.parentElement === r && r.removeChild(f),
                f = null
            }
            function d(e) {
            ...
            f.addEventListener(e.mobile ? t.TOUCH_END : t.MOUSE_UP, d),
            r.appendChild(f),
            a(),
            {
                update: u,
    ...
    r = function() {
        ...
        function e(e, t) {
            function n() {
                ...
                u.ctx.font = "bold " + i(.6 * t) + 'px "Arial"',
            ...
            function a() {
                u.ctx && u.ctx.clearRect(0, 0, s.width, s.height),
                s && s.parentElement === e && e.removeChild(s),
                s = null
            }
...
, function(e, t, n) {
    var i, r;
    i = [n(9), n(3), n(13), n(14), n(53), n(54), n(55), n(56), n(52), n(57), n(58), n(59), n(60), n(61), n(62)],
    r = function(e, t, n, i, r, o, a, s, c, u, l, d, f, h, E) {
        function p() {
            function s(e, t) {
                ...
                try {
                    ...
                    var n = x.metrics;
                    if (!n)
                        throw new w(o.METRICS_NO_OBJECT,r.SETUP.METRICS_NO_OBJECT);
                    if ("object" != typeof n)
                        throw new w(o.METRICS_NOT_OBJECT,r.SETUP.METRICS_NOT_OBJECT);
                    if (!Object.getOwnPropertyNames(n).length)
                        throw new w(o.METRICS_EMPTY_OBJECT,r.SETUP.METRICS_EMPTY_OBJECT);
                    for (var a in n)
                        if (!n.hasOwnProperty(a) || !C.hasOwnProperty(a) || (C[a] = n[a],
                        0 === a.indexOf("customField"))) {
                            var s, m = a.split("customField");
                            if (!(m.length > 1 && 0 === m[0].length))
                                throw new w(o.METRICS_PROPERTY_INVALID.replace("$key$", a),r.SETUP.METRICS_PROPERTY_INVALID);
                            if (s = parseInt(m[1]),
                            isNaN(s))
                                throw new w(o.METRICS_INDEX_INVALID.replace("$key$", a),r.SETUP.METRICS_INDEX_INVALID);
                            if (s.toString() != m[1])
                                throw new w(o.METRICS_INDEX_INCORRECT.replace("$key$", a),r.SETUP.METRICS_INDEX_INCORRECT);
                            if (s < 1 || s > 10)
                                throw new w(o.METRICS_INDEX_RANGE.replace("$key$", a),r.SETUP.METRICS_INDEX_RANGE);
                            b["application_custom_field_" + m[1]] = n[a]
                        }
                    if (!C.accountId || !C.accountKey)
                        throw new w(o.METRICS_NO_CREDENTIALS,r.SETUP.METRICS_NO_CREDENTIALS);
                    for (var a in n)
                        P.debug("metrics config[" + a + "]: " + JSON.stringify(n[a]));
                    S = u.create(),
                    A = l.create(),
                    N = d.create(C.statsInterval),
                    I = f.create(),
                    R = h.create(),
                    O = E.create(),
                    v = c.create({
            ...
            function p(e) {
                try {
                    ...
                    case i.STOP_BUFFERING:
                        I.end(),
                        _(I, "measure", e, t) && (t.message = t.player_event_name = "BUFFERING",
                        T(t));
                        break;
                    case i.PAUSE:
                        _(R, "measure", e, t),
            ...
            function T(e) {
                P.debug("send " + e.player_event_name),
                v.send(e.player_event_name, e)
            }
            function y() {
                if ("object" == typeof g && "function" == typeof g.off)
                    for (var e in i)
                        i.hasOwnProperty(e) && g.off(i[e], p);
                v && (v.destroy(),
                v = null),
                S = null,
                A = null,
            ...
            var v, g, S, A, N, I, R, O, C = a.create().metrics, b = {}, P = n.create("NanoMetrics"), D = e, w = t, L = {}, U = {}, M = {}, x = {}, F = 0;
            return {
                setup: s,
                destroy: y
            }
        }
        return p.emptyConfig = a,
        p.validConfig = s,
        p
    }
    .apply(t, i),
        ...
        function t(t) {
            function n(e, t) {
                try {
                    ...
                    var r = c[s];
                    if (r.open("POST", l, f),
                    r.onreadystatechange = function(e, t) {
                    ...
                    "undefined" != typeof t) {
                        ...
                        if ("object" == typeof t)
                            try {
                                t = JSON.stringify(t),
                                d.debug("#" + s + " " + e + " send " + t),
                                setTimeout(i.bind(null, s, e, "suspend"), 5e3),
                                r.send(t)
                            } catch (e) {
            ...
            function i(e, t, n) {
                "undefined" != typeof c[e] && (d.debug("#" + e + " " + t + " " + n + " " + c[e].status),
                delete c[e])
            }
            function r() {
                for (var e in c)
            ...
            for (var a in o)
                o.hasOwnProperty(a) && t && t.hasOwnProperty(a) && void 0 !== t[a] && (o[a] = t[a]);
            var s = 0
              , c = {}
            ...
            function e(e, t) {
                ...
                try {
                    if (e.data && e.data.stats && "object" == typeof e.data.stats) {
                        var r = e.data.stats;
                        for (n in i)
                            r.hasOwnProperty(n) && "number" == typeof r[n] && (i[n] = r[n])
                    }
                } catch (e) {}
                var o = {}
                  , a = [{
                ...
                return a.forEach(function(e, t) {
                    var n = i[e.start]
                      , r = i[e.end];
                    r - n >= 0 && (e.value = Math.floor(r - n)),
                    o[e.measurement + "_relative"] = e.value,
                    o[e.measurement + "_absolute"] = i[e.end]
                }),
                o.play_start_time_total = o.play_playing_absolute,
                o
            }
            return {
                measure: e
    ...
    r = function() {
        function e(e) {
            function t(e, t) {
                ...
                try {
                    for (a += 1,
                    s.push(n.buffer.delay.current),
                    c.push(n.bitrate.current),
                    u.push(n.framerate.current); s.length > o; )
                        s.shift();
                    for (; c.length > o; )
                        c.shift();
                    for (; u.length > o; )
                    ...
                    if (a % o === 0) {
                        ...
                        l.stats_buffer_min = Math.round(1e3 * i[0]) / 1e3,
                        l.stats_buffer_max = Math.round(1e3 * i[i.length - 1]) / 1e3,
                        l.stats_bitrate_average = Math.round(r.reduce(function(e, t) {
                            return e + t
                        }, 0) / r.length / 1e3),
                        l.stats_bitrate_min = Math.round(r[0] / 1e3),
                        l.stats_bitrate_max = Math.round(r[i.length - 1] / 1e3),
                        l.stats_frame_rate_average = Math.round(d.reduce(function(e, t) {
                            return e + t
                        }, 0) / d.length * 1e3) / 1e3,
                        l.stats_frame_rate_min = d[0],
                        l.stats_frame_rate_max = d[d.length - 1],
                        l.stats_measure_count += 1,
                        l.stats_quality_dropped_video_frames = n.quality.droppedVideoFrames,
                        l.stats_quality_dropped_video_frames_current = n.quality.droppedVideoFramesCurrent,
                        l.stats_quality_corrupted_video_frames = n.quality.corruptedVideoFrames,
                        l.stats_quality_corrupted_video_frames_current = n.quality.corruptedVideoFramesCurrent,
                        l.stats_quality_creation_time = n.quality.creationTime,
                        l.stats_quality_total_video_frames = n.quality.totalVideoFrames,
                        l
                    }
                    return !1
                } catch (e) {
        ...
        function e() {
            ...
            function n(e, t) {
                if (a) {
                    ...
                    n >= r) {
                        s.push(n),
                        c.buffering_duration_current = n,
                        c.buffering_duration_total += n,
                        c.buffering_count += 1,
                        c.buffering_duration_average = Math.round(c.buffering_duration_total / c.buffering_count * 1e3) / 1e3;
                        for (var i in c)
                            !/buffering_count/.test(i) && c[i];
                        return c
                    }
                }
                return !1
            ...
            function i(e, t) {
                if (e && t) {
                    ...
                    var n = {};
                    for (var i in c)
                        !/buffering_duration_current/.test(i) && (n[i] = c[i]),
                        c[i] = 0;
                    return n.time_played_total = t.time_played,
                    n.time_elapsed_total = t.time_elapsed,
                    n.time_buffering_total = n.buffering_duration_total,
                    n
                }
            }
            var r = 1
...
, function(e, t, n) {
    var i, r;
    i = [n(3), n(64), n(65), n(66), n(67), n(68), n(69)],
        ...
        function s(i) {
            ...
            return new Promise(function(a, s) {
                ...
                if (i && i.source && i.source.bintu) {
                    if (i.source.bintu.apiurl || (i.source.bintu.apiurl = "https://bintu.nanocosmos.de"),
                    !i.source.bintu.streamid)
                        return void s(new e(n.BINTU_NO_STREAM_ID,t.SETUP.BINTU_NO_STREAM_ID));
                    r = new o(i.source.bintu.apiurl,null,null,"player"),
                    r.getStream(i.source.bintu.streamid, function(r) {
                        try {
                            ...
                            o.playout)
                              ...
                              , d = u.hls
                              , f = u.h5live;
                            if (l && !l.length && !f || f && !f.length)
                                s(new e(n.BINTU_STREAM_NOT_LIVE,t.SETUP.BINTU_STREAM_NOT_LIVE));
                            else {
                                if (d && d.length) {
                                    var h = d[0].url;
                                    i.source.hls = h
                                ...
                                if (f && f.length) {
                                    if (i.source.h5live = i.source.h5live || {},
                                    !i.source.h5live.server && (i.source.h5live.server = {}))
                                        for (var E in f[0].server)
                                            f[0].server.hasOwnProperty(E) && (i.source.h5live.server[E] = f[0].server[E].replace("bintu-stream", "bintu-h5live"));
                                    i.source.h5live.rtmp = {},
                                    i.source.h5live.rtmp.url = f[0].rtmp.url,
                                    i.source.h5live.rtmp.streamname = f[0].rtmp.streamname
                                } else
                                    l && l.length && (i.source.h5live = i.source.h5live || {},
                                    i.source.h5live.rtmp = {},
                                    i.source.h5live.rtmp.url = l[0].url,
                                    i.source.h5live.rtmp.streamname = l[0].streamname)
                            }
                            a(i)
                        } catch (e) {
                            c(e)
...
, function(e, t, n) {
    ...
    r = function() {
        ...
        var e = function(e, t, n, i) {
            if (!(e.length > 0 && ("string" == typeof e || e instanceof String)))
                throw new Error("The param 'apiUrl' must be of type 'string' and also may not be empty string.");
            if (this.apiUrl = e,
            t && ("string" == typeof t || t instanceof String) && (this.apiKey = t),
            n && ("string" == typeof n || n instanceof String) && (this.playerKey = n),
          ...
          , n = function(e, t, n, i, r, o) {
            var a = this;
            a.method = e || "GET",
            a.url = t || "http://localhost:8088",
            a.header = n || {},
            a.async = i || !0,
            a.onSuccess = r || function(e) {}
            ,
            a.onError = o || function(e) {}
            ,
            a.Send = function(e) {
                var t = new XMLHttpRequest;
                t.open(a.method, a.url, a.async);
                for (var n in a.header)
                    t.setRequestHeader(n, a.header[n]);
        ...
        t.createStream = function(e, t, i) {
            ...
            r.onSuccess = t,
            r.onError = i,
            "object" == typeof e && "function" == typeof e.push && e.length > 0 && ("string" == typeof e[0] || e[0]instanceof String) ? r.Send({
                tags: e
            }) : r.Send()
        }
        ,
        t.getStream = function(e, t, i) {
            ...
            if (!this.apiKey && "api" === this.keyMode)
                return "function" == typeof i && i({
                    error: "no api key set",
                    request: {
                        responseText: "no response error"
        ...
        t.getStreams = function(e, t, i) {
            ...
            if (!this.playerKey && "player" === this.keyMode)
                return "function" == typeof i && i({
            ...
            if (e instanceof BintuStreamFilter) {
                if (0 === e.tags.length && "player" === this.keyMode)
                    return "function" == typeof i && i({
                        error: "no tags set",
                        request: {
                            responseText: "no response error"
        ...
        t.tagStream = function(e, t, i, r) {
            ...
            o.onSuccess = i,
            o.onError = r,
            "object" == typeof t && "function" == typeof t.push && t.length > 0 && ("string" == typeof t[0] || t[0]instanceof String) ? o.Send({
                tags: t
            }) : o.Send()
        }
        ,
...
, function(e, t, n) {
    ...
    r = function() {
        "use strict";
        function e() {
            this.state = this.setState(e.STATE.ALL),
            this.tags = []
        }
        var t = e.prototype;
        ...
        t.addTags = function(e) {
            if ("object" != typeof e || "function" != typeof e.push || !(0 === e.length || e.length > 0 && ("string" == typeof e[0] || e[0]instanceof String)))
                throw new Error("The param 'tags' must be of type 'string array'");
            return this.tags = this.tags.concat(e),
            this.tags = this._reduceDuplicates(this.tags),
            this
        }
        ,
        t.getQueryString = function() {
            ...
            if ("object" == typeof this.tags && "function" == typeof this.tags.push && this.tags.length > 0)
                for (var t = 0; t < this.tags.length; t += 1)
                    "string" == typeof this.tags[t] && (e += 0 === t ? "?" : "&",
                    e += "tags[]=" + this.tags[t]);
            return "string" == typeof this.state && this.state.length > 0 && (e += e.indexOf("?") === -1 ? "?" : "&",
            e += "state=" + this.state),
            e
        }
        ,
...
, function(e, t, n) {
    ...
    r = function() {
        function e(e, t, n) {
            function i() {
                for (var n in t)
                    t.hasOwnProperty(n) && e.on(t[n], o)
            }
            function r() {
                for (var n in t)
                    t.hasOwnProperty(n) && e.off(t[n], o)
            }
            function o(e) {
                n.emit(e.name, e)
            }
...
, function(e, t, n) {
    var i, r;
    i = [n(73), n(75), n(16), n(74), n(14), n(28), n(72), n(79), n(5), n(70), n(81), n(157)],
    r = function(e, t, n, i, r, o, a, s, c, u, l, d) {
        "use strict";
        function f(t) {
            l.validatePlayerDivId(t),
            this.version = s.CORE,
            console.debug("NanoCore api version: " + this.version),
            this.type = "default",
            this.id = Math.round(1e11 * Math.random()).toString(),
            this._playerDivId = t,
            this._dummyPlayer = new e(this._playerDivId),
        ...
        return h.setup = function(e) {
            return new d(function(n, i) {
                var a = e && e.events && e.events.onError ? e.events.onError : null
                  , s = function(e) {
                    e.code || (e.code = c.SETUP.EXCEPTION),
                    e.message || (e.message = "An unknown error occured during setup.");
                    var t = {
                        name: "Error",
                        data: {
                ...
                try {
                    this._realPlayer && this._realPlayer !== this._dummyPlayer && (this._realPlayer.destroy(),
                    this._realPlayer = this._dummyPlayer),
                    t.create(this._playerDivId, e).then(function(t) {
                        this.version = t.version,
                        this.type = t.type,
                        this._realPlayer = t,
                        this._realPlayer.id = this.id,
                        this._propagator = u.create(t, r, this),
                        this._realPlayer.setup(e).then(function(e) {
...
, function(e, t, n) {
    ...
    r = function(e, t, n, i, r, o) {
        function a(e) {
            ...
            if (!n.length)
                throw new t(i.CLIENT_NOT_SUPPORTED,o.SETUP.CLIENT_NOT_SUPPORTED);
            return n
        }
        function s(e, n) {
            var a = {};
            a[r.H5LIVE_WSS] = "h5live",
            a[r.H5LIVE_HLS] = "h5live",
            a[r.FLASH] = "h5live",
            a[r.NATIVE] = "hls";
            var s = []
              , c = e.filter(function(e) {
                ...
                return e.supportedTechniques.forEach(function(e) {
                    s.push(a[e]),
                    t === !1 && (t = n.hasOwnProperty("source") && n.source.hasOwnProperty(a[e]))
                }),
                t
            });
            if (!c.length)
                throw new t(i.SOURCE_NOT_SUPPORTED,o.SETUP.SOURCE_NOT_SUPPORTED);
            return c
        }
        function c(e, n) {
            var r = []
            ...
            if (!s.length)
                throw new t(i.FORCE_NOT_SUPPORTED.replace("$tech$", n.playback.forceTech),o.SETUP.FORCE_NOT_SUPPORTED);
            return s
        }
        function u(e, t) {
            var n = e[0];
...
, function(e, t, n) {
    var i, r;
    i = [n(73), n(29), n(78), n(79), n(9), n(10), n(2), n(11), n(80), n(81), n(12), n(16), n(74), n(28), n(83), n(14), n(5), n(84), n(82), n(72), n(85), n(90), n(91), n(93), n(95), n(113), n(122), n(86), n(88), n(87), n(89), n(97)],
    r = function(e, t, n, i, r, o, a, s, c, u, l, d, f, h, E, p, m, _, T, y, v, g, S, A, N, I, R, O, C, b, P, D) {
        "use strict";
        function w(e) {
            u.validatePlayerDivId(e),
            this._setBaseValues(e)
        }
        var L = o.log;
        w.getSupportedTechniques = function() {
            var e = [];
            return l.isH5LiveKnownUnsupported || (l.hasMediaSource && e.push(T.H5LIVE_WSS),
            (l.mustUseHLS || l.canUseHLS) && e.push(T.H5LIVE_HLS)),
            e
        }
        ,
        w.supportedTechniques = w.getSupportedTechniques(),
        ...
        return U._setBaseValues = function(e) {
            ...
            this._info = r,
            this.config = d.create(),
            this._playerDivId = "",
            this._playing = !1,
            this._streamInfo = null,
            this._pauseReason = "",
            this._playerDivId = e,
            this._mediaElementId = "h5live-" + e,
            this._componentEmitter = new s,
        ...
        U._baseSetup = function(e, i) {
            ...
            a.merge(i, this.config),
            a.clean(this.config);
            var o;
            if (o = u.validateConfig(e, i))
                return o;
            i.playback.videoId && (this._mediaElementId = i.playback.videoId),
            ...
            d && h ? this.config.url = d + "/" + h : this.config.url = "",
            ...
            for (var E in this._components)
                this._componentListeners.hasOwnProperty(E) && this._componentListeners[E].length && t.add({
                    target: this._componentEmitter,
                    listeners: this._componentListeners[E]
                });
            for (var m in p)
                (this._outwardEvents || (this._outwardEvents = [])) && this._outwardEvents.push({
                    from: p[m],
                    to: p[m]
                });
            return this._outwardTranslator = n.create(this._componentEmitter, this, this._outwardEvents),
            this._emitConfig(),
            this._setupVideoElement(s),
            o
        }
        ,
        U.setup = function(e) {
        ...
        ,
        U._destroy = function() {
            this._setState(this.STATE.DESTROYING),
            this._playing && this.pause(this.state),
            this.emit(p.DESTROY),
            this._outwardTranslator && this._outwardTranslator.destroy(),
            this._outwardTranslator = null;
            for (var e in this._components)
                this._components.hasOwnProperty(e) && (this._components[e].destroy(),
                delete this._components[e]);
            for (var n in this._componentListeners)
                this._componentListeners.hasOwnProperty(n) && this._componentListeners[n].length && t.remove({
                    target: this._componentEmitter,
        ...
        ,
        U.destroy = U._destroy,
        U._emitConfig = function() {
        ...
        U._setState = function(e) {
            ...
            this.state = e,
            t.state = e,
            this._componentEmitter.emit(C.STATE_CHANGE, t)
        }
        ,
        ...
        U._onLogicError = function(e) {
            ...
            this.emit(p.ERROR, e.data),
            this.pause(this.state)
        }
        ,
        U._onPlayStartError = function(e) {
            switch (this._debug(e.data.error.name + ": " + e.data.error.message, 1),
            e.data.error.name) {
            case "NotAllowedError":
                e.data.automuted ? this._emitWarning("Unmuted autoplay failed by autoplay policy, but 'automute' is enabled. Try to play muted.") : (this._setState(this.STATE.PLAYBACK_NOT_STARTED),
                this._emitError(m.PLAYER.INTERACTION_REQUIRED, "Playback must be initialized by user gesture."))
            }
        }
        ,
        U._onError = function(e) {
            if (this.state !== this.STATE.PAUSING && this.state !== this.STATE.PAUSED) {
                ...
                this._debug('error media with state "' + this._getState() + '", networkstate "' + this._getNetworkState() + '"', 3),
                this._debug("error message: " + t, 3),
                n === MediaError.MEDIA_ERR_DECODE && this.state !== this.STATE.LOADING && setTimeout(this.play.bind(this), 1e3),
                this._setState(this.STATE.PLAYBACK_ERROR),
                this._emitError(n + 3e3, t)
            }
        }
        ,
        ...
        U.play = function() {
            ...
            L("nanoplayer (" + this._playerDivId + "): play in state " + this.state, 1),
            this.state < this.STATE.READY ? this._emitError(m.PLAYER.NOT_CONFIGURED, "Could not play because player has not been configured.") : this.state === this.STATE.READY || this.state === this.STATE.PAUSED ? (this._playing = !0,
            e ? setTimeout(function() {
                this.state === this.STATE.LOADING && (this._componentEmitter.emit(D.PLAY),
                this._componentEmitter.emit(O.PLAY, {
                    external: !0
                }))
            }
            .bind(this), e) : (this._componentEmitter.emit(D.PLAY),
            this._componentEmitter.emit(O.PLAY, {
                external: !0
            })),
            this._preparePlay(e)) : this.state === this.STATE.PAUSING && (L("nanoplayer (" + this._playerDivId + "play in PAUSING state, setting flag to resume"),
            this._resumeOnPause = !0)
        }
        ,
        U._onConnectionInitializationError = function(e) {
            this._debug('error init connection with state "' + this._getState() + '", networkstate "' + this._getNetworkState() + '"', 2),
            this.networkState = e.connectionState;
            var t = "Connection initialization error."
              , n = e ? e.data : void 0;
            n && n.message && (t = n.message),
            n && n.code && (t += " (code:" + n.code + ")"),
            n && n.name && (t = n.name + ": " + t),
            this._setState(this.STATE.CONNECTION_ERROR),
            this._emitError(m.NETWORK.COULD_NOT_ESTABLISH_CONNECTION, t)
        }
        ,
        U._onConnectionError = function(e) {
            this._debug('error connection with state "' + this._getState() + '", networkstate "' + this._getNetworkState() + '"', 2),
            this.networkState = e.connectionState;
            ...
            n && n.name && (t = n.name + ": " + t),
            this._setState(this.STATE.CONNECTION_ERROR),
            this._emitError(m.NETWORK.CONNECTION_ERROR, t)
        }
        ,
        ...
        U._onConnectionOpen = function(e) {
            e.data.count ? this._debug("connection open after " + e.data.count + " reconnect tries", 1) : this._debug("connection open", 1),
            this.networkState = e.connectionState
        }
        ,
        U._onConnectionClosed = function(e) {
            ...
            var n = e.data.code;
            n > 1e3 && n < 4e3 && (n += 3100),
            this._debug('closed connection with state "' + this._getState() + '", networkstate "' + this._getNetworkState() + '"', 2),
            n > 4e3 && this._emitError(n, t)
        }
        ,
        U._onConnectionDestroyed = function(e) {
            this._debug("connection destroyed" + (e.data.silent ? ", but silent" : ""), 1),
            this.networkState = e.connectionState,
            this.state === this.STATE.READY || e.data.silent || this.pause(this.state)
        }
        ,
        U._onConnectionReconnecting = function(e) {
            this._debug("reconnect attempt " + e.data.count + " started", 1),
            this.networkState = e.connectionState
        }
        ,
        U._onConnectionReconnectionImminent = function(e) {
            var t = e.data.code;
            t > 1e3 && t < 4e3 && (t += 3100),
            this._debug("connection " + e.data.count + (e.data.count > 1 ? " times" : " time") + " unexpectedly closed with code " + t + ", but a reconnect will be prepared", 1),
            this._debug("reconnect attempt " + e.data.count + " starts in " + Math.round(e.data.delay) + " ms", 1),
            ("iOS" !== r.os || "iOS" === r.os && e.data.count > 1) && this._emitWarning("Connection error: closed " + e.data.count + (e.data.count > 1 ? " times" : " time") + " unexpectedly with code " + t + ", but a reconnect will be prepared in " + (e.data.delay / 1e3).toFixed(3) + " s"),
            this.networkState = e.connectionState,
            this._playing && "iOS" !== r.os && (this._setState(this.STATE.RECONNECTION_IMMINENT),
            this.pause(this.state),
            this.play(e.data.delay))
        }
        ,
        ...
        U._onStreamInfo = function(e) {
            ...
            this.emit(p.STREAM_INFO, e.data)
        }
        ,
        U._onStreamInfoUpdate = function(e) {
            this._debug("onStreamInfoUpdate", 2),
            this.emit(p.STREAM_INFO_UPDATE, e.data)
        }
        ,
        U._onNoKeepConnection = function(e) {
            this._debug("onNoKeepConnection", 2),
            this._emitWarning(e.data.message)
        }
        ,
        U._onMimeTypeUnsupported = function() {
            this._setState(this.STATE.PLAYBACK_ERROR),
            this._emitError(m.MEDIA.NOT_SUPPORTED, "The received audio/video is not supported")
        }
        ,
        U._onMediaError = function(e) {
            this._setState(this.STATE.PLAYBACK_ERROR),
            this._emitError(m.PLAYER.PLAYBACK_ERROR, e.data)
        }
        ,
        U._onMediaSuspended = function() {
            r.mobile ? (this._setState(this.STATE.PLAYBACK_SUSPENDED),
            this._emitError(m.PLAYER.PLAYBACK_SUSPENDED, "Playback suspended by external reason.")) : (this._setState(h.PLAYBACK_RESTARTING),
            this.pause(this.state),
        ...
        U.emit = function(e, t) {
            ...
            n.state = this.state,
            "Error" === e && n.data.code && n.data.message && this._debug("error " + n.data.code + " " + n.data.message, 1),
            this._emit(n.name, n)
        }
        ,
        ...
        U._triggerPause = function() {
            return this.state === this.STATE.PAUSED ? void L("nanoplayer (" + this._playerDivId + "): trigger pause but already in state paused") : (L("nanoplayer (" + this._playerDivId + '): trigger pause with reason "' + this._pauseReason + '", state "' + this._getState() + '", networkstate "' + this._getNetworkState() + '"', 3),
            this._setState(this.STATE.PAUSED),
            this.emit(p.PAUSE, {
                reason: this._pauseReason
            }),
            void (this._resumeOnPause && (this._resumeOnPause = !1,
            this.play())))
        }
        ,
        U.pause = function() {
            var e = arguments.length ? arguments[0] : 0;
            L("nanoplayer (" + this._playerDivId + "): pause in state " + this.state, 2),
            this.state < this.STATE.READY ? this._emitError(m.PLAYER.NOT_PLAYING, "Could not pause because player was not in playing state before.") : this.state !== this.STATE.PAUSED && this.state !== this.STATE.PAUSING && (this._pauseReason = this._getPauseReason(e),
            this._setState(this.STATE.PAUSING),
            this._playing = !1,
            this._resumeOnPause = !1,
            this._componentEmitter.emit(D.PAUSE),
            this._componentEmitter.emit(O.PAUSE),
            this._triggerPause())
        }
        ,
        U.mute = function() {
        ...
        U.updateSource = function(e) {
            return new Promise(function(t, n) {
                ...
                if (i = u.validateConfig(w.supportedTechniques[0], {
                    ...
                    i.message.replace("create", "update"),
                    this._emitError(i.code, i.message),
                    n(i);
                else {
                    a.merge(e, this.config.source),
                    a.clean(this.config.source);
                    ...
                    s && c ? this.config.url = s + "/" + c : this.config.url = "",
                    this._componentEmitter.emit(O.UPDATE_SOURCE, {
                        source: e
                    }),
                    this.state !== this.STATE.PLAYING && this.state !== this.STATE.LOADING && this.state !== this.STATE.BUFFERING || (this._setState(h.PLAYBACK_RESTARTING),
                    this.pause(this.state),
                    setTimeout(this.play.bind(this), 0)),
                    t(this.config)
                }
        ...
        U._onMediaPlaying = function(e) {
            var t = this.state;
            this._setState(h.PLAYING),
            this.emit(t === h.BUFFERING ? p.STOP_BUFFERING : p.PLAY, e.data),
            this._debug("state is PLAYING")
        }
        ,
        U._onMediaBuffering = function() {
            this._setState(h.BUFFERING),
            this.emit(p.START_BUFFERING)
        }
        ,
        U.STATE = h,
        U.NETWORK_STATE = E,
...
, function(e, t, n) {
    ...
    r = function(e, t, n, i) {
        function r(r, o) {
            var a = o.source;
            if (!a || !a.h5live)
                return new e(t.CONFIG_SOURCE,i.SETUP.SOURCE_NOT_SUPPORTED);
            var s = o.source.h5live;
            if (!(s.rtmp && s.rtmp.url && s.rtmp.streamname || s.params && s.params.url && s.params.stream))
                return new e(t.CONFIG_RTMP,i.SETUP.CONFIG_RTMP);
            if (r === n.H5LIVE_WSS && (!s.server || s.server && !s.server.websocket))
                return new e(t.CONFIG_WSS,i.SETUP.CONFIG_WSS);
            if (r === n.H5LIVE_HLS) {
                if (!s.server || s.server && !s.server.hls)
                    return new e(t.CONFIG_HLS,i.SETUP.CONFIG_HLS);
                if (o.playback && o.playback.metadata && !s.server.websocket)
                    return new e(t.CONFIG_METADATA,i.SETUP.CONFIG_METADATA)
            }
            return !(s.server && (s.server.websocket || s.server.hls) || s.token) && new e(t.CONFIG_TOKEN,i.SETUP.CONFIG_TOKEN)
        }
        function o(t) {
            if (!("string" == typeof t || t instanceof String))
                throw new e('The param "playerDivId" must be of type "String".');
            var n = document.getElementById(t);
            if (!n)
                throw new e('The param "playerDivId" must be the id of an existing "div" element.');
            if ("DIV" !== n.tagName)
                throw new e('The element with the id "' + t + '" is not a "div" element.');
            return !0
        }
        return {
            validateConfig: r,
...
, function(e, t, n) {
    var i, r;
    i = [n(29), n(14), n(86), n(87), n(88), n(89), n(13)],
    r = function(e, t, n, i, r, o, a) {
        function s(n) {
            function i() {
                e.add({
...
, function(e, t, n) {
    var i, r;
    i = [n(29), n(5), n(14), n(86), n(87), n(88), n(89), n(13)],
        ...
        function c(i) {
            ...
            function d(e) {
                ...
                A.forEach(function(i) {
                    i.event === e.name && (t = i.code ? i.code : e.data.code,
                    n = i.message ? i.message : e.data.reason,
                    i.defer ? setTimeout(f.bind(this, t, n), 0) : f(t, n))
                })
            }
            function f(e, t) {
                l(n.ERROR, {
            ...
            function h(e) {
                var t;
                T && T.quality && (t = T.quality),
                T = e.data.stats,
                t && !T.quality && (T.quality = t);
                var i, r = "stats error";
                try {
                    r = JSON.stringify(T),
                    i = JSON.parse(r),
                    delete i.buffer.update,
                    delete i.buffer.delay.before
                } catch (e) {}
                l(n.STATS, {
                    stats: i
                })
            ...
            function p(e) {
                y.debug("mediaSource " + (e.type === r.SOURCE_ENDED ? "ended" : "closed") + ", readyState: " + e.data.readyState),
                l(n.PLAYBACK_FINISHED)
            }
            function m(e) {
                e.data.muted !== g ? (g = e.data.muted,
                l(g ? n.MUTE : n.UNMUTE, {
                    volume: v
                })) : e.data.volume !== v && (v = e.data.volume,
                l(n.VOLUME_CHANGE, {
                    volume: v
                }))
            }
            ...
            var T, y = s.create("FacadePropagator"), v = 1, g = !1, S = [{
...
, function(e, t, n) {
    var i, r;
    i = [n(92), n(13), n(12), n(29), n(28), n(86), n(87), n(89), n(88)],
    r = function(e, t, n, i, r, o, a, s, c) {
        function u(t, u) {
            function v() {
                i.add({
                    target: t,
            ...
            function S(e) {
                w = n.mustUseHLS || e.data.config.playback.allowSafariHlsFallback && n.canUseHLS,
                i.add({
                    target: t,
                    listeners: w ? G : k
                })
            ...
            function N(t) {
                var n = [l, u, t].join(d);
                e && "function" == typeof e.mark && U.indexOf(n) === -1 && (e.mark(n),
                U.push(n)),
                M[t] || t === T && (t !== T || [p, m, _].indexOf(x) === -1) || (x = t,
                M[t] = e.now(),
                y.debug(t + ": " + M[t]),
                t === T && I())
            }
            function I() {
                ...
                f.filter(function(e) {
                    ...
                    var e = M[h];
                    for (var n in M)
                        M.hasOwnProperty(n) && (M[n] = Math.round(M[n] - e));
...
, function(e, t, n) {
    ...
    r = function() {
        var e = Date.now ? Date.now() : +new Date
          ...
          , o = function(e, t) {
            for (var i, r = n.length; r--; )
                i = n[r],
                i.entryType !== e || void 0 !== t && i.name !== t || n.splice(r, 1)
        };
        ...
        void 0 === window.performance && (window.performance = t),
        window.performance
    }
    .apply(t, i),
    !(void 0 !== r && (e.exports = r))
...
, function(e, t, n) {
    var i, r;
    i = [n(29), n(5), n(94), n(14), n(28), n(86), n(87), n(88), n(89), n(13), n(9)],
    r = function(e, t, n, i, r, o, a, s, c, u, l) {
        function d(i) {
            function o() {
                e.add({
            ...
            function _(e) {
                e.name === s.DOCUMENT_HIDDEN ? A = !0 : (A && (N = !0),
                A = !1,
...
, function(e, t, n) {
    var i, r;
    i = [n(13), n(11), n(12), n(29), n(78), n(97), n(86), n(88), n(87), n(89), n(98), n(99), n(96), n(100), n(101), n(102), n(103), n(104), n(106), n(107), n(108), n(110), n(111), n(112)],
    r = function(e, t, n, i, r, o, a, s, c, u, l, d, f, h, E, p, m, _, T, y, v, g, S, A) {
        "use strict";
        function N(N) {
            function I() {
                D.debug("init"),
            ...
            function O(e) {
                w.push(n.mustUseHLS || e.data.config.playback.allowSafariHlsFallback && n.canUseHLS ? y.create(P) : T.create(P)),
                e.data.config.playback.metadata && w.push(S.create(P))
            }
            var C, b, P = new t, D = e.create("LogicManager"), w = [], L = [{
                from: l.SEEK,
                to: a.SEEK
            }, {
                from: l.RATE,
...
, function(e, t, n) {
    var i, r;
    i = [n(13), n(12), n(29), n(99), n(96), n(83), n(105)],
    r = function(e, t, n, i, r, o, a) {
        function s(s) {
            function c() {
                P.debug("init"),
            ...
            function l(e) {
                P.debug(e.name + ": network state change from " + O(C) + " to " + O(e.connectionState)),
                C = e.connectionState
            }
            function d(e) {
                if (F) {
                    var t = e.data.onServerInfo.capabilities
                      ...
                      , r = parseFloat(n);
                    t.indexOf("onPlay") === -1 && t.indexOf("onPause") === -1 && (F = !1,
                    s.emit(i.NO_KEEP_CONNECTION, {
            ...
            function f(e) {
                var n = e.data.config;
                v(n.source.h5live),
                T(n.source.h5live.server),
                g(n.source.h5live.security),
                b = n.id,
                x = n.playback.metadata,
                F = n.playback.keepConnection,
                G = n.playback.autoplay,
                k = t.mustUseHLS || n.playback.allowSafariHlsFallback && t.canUseHLS,
                F && m()
            }
            function h(e) {
                V = !0;
                var t = e.data.source;
                P.debug("update source: " + JSON.stringify(t)),
                v(t.h5live),
                T(t.h5live.server),
                g(t.h5live.security),
                F ? G || (V = !1,
            ...
            function E() {
                if (G = !0,
                C === o.OPEN ? (P.debug("send network play"),
                s.emit(i.NETWORK_PLAY)) : M || m(),
                k) {
                    var e = y("hls") + S() + A() + R();
            ...
            function m() {
                if (C !== o.OPEN && (x || L || !k)) {
                    G ? I("paused") : N("paused"),
                    x && k ? N("metastreamonly") : I("metastreamonly"),
                    !x && L && k ? N("checkandclose") : I("checkandclose");
                    var e = S() + A() + R()
                      , t = y("websocket")
                      , n = t + "/" + e;
                    P.debug("connect to: " + n, 1),
                    s.emit(i.CONNECT, {
                        url: n
                    }),
                    k || s.emit(i.URL, {
            ...
            function T(e) {
                if ("object" == typeof e) {
                    for (var t = ["websocket", "hls", "progressive"], n = 0; n < t.length; n++)
                        e[t[n]] && "string" == typeof e[t[n]] && 0 !== e[t[n]].length && (D || (D = {}),
                        D[t[n]] = e[t[n]]);
            ...
            function y(e) {
                return "string" == typeof D[e] && 0 !== D[e].length ? (P.debug('get connection server from type "' + e + '": ' + D[e], 3),
                D[e]) : (s.emit(i.NO_SERVER_ERROR),
                "")
            }
            function v(e) {
                P.debug("set connection config", 3);
                var t, n = e.rtmp, r = e.params;
                if ("object" == typeof n && n.url && n.url.length && n.streamname && n.streamname.length || r) {
                    for (t in n)
                        if (n.hasOwnProperty(t)) {
                            var o = t.replace("name", "");
                            w.hasOwnProperty(o) && (w[o] = n[t],
                            P.debug("set connection config rtmp: " + o + ":" + w[o]))
                        }
                } else
                    s.emit(i.MISSING_RTMP_ERROR);
                if (e.token && w.hasOwnProperty("token") && (w.token = e.token,
                P.debug("set connection config token: " + w.token)),
                "object" == typeof r)
                    for (t in r)
                        r.hasOwnProperty(t) && (w[t] = r[t],
                        P.debug("set connection param: " + t + ":" + w[t]))
            }
            function g(e) {
                if (L = null,
                e) {
                    L = {},
                    P.debug("set security config", 3);
                    for (var t in e)
                        e.hasOwnProperty(t) && e[t].length && (L[t] = e[t],
                        P.debug("set security config " + t + ": " + L[t]))
                }
            }
            function S() {
                var e = "?";
                for (var t in w)
                    w.hasOwnProperty(t) && ("cid" === t && (w[t] = Math.round(1e6 * Math.random()).toString()),
                    "pid" !== t || w[t].length || (w[t] = b),
                    w[t].length && (e += t + "=" + encodeURIComponent(w[t]) + "&"));
            ...
            function A() {
                var e = "&";
                for (var t in L)
                    L.hasOwnProperty(t) && L[t].length && (e += t + "=" + encodeURIComponent(L[t]) + "&");
                return e.lastIndexOf("&") === e.length - 1 && (e = e.substr(0, e.length - 1)),
                e
            }
            function N(e) {
            ...
            function R() {
                for (var e = "", t = "&flags=", n = 0, i = U.length; n < i; n += 1)
                    e += U[n],
                    n === i - 1 ? e = t + encodeURIComponent(e) : e += ",";
                return e
            }
            function O(e) {
                for (var t in o)
                    if (o.hasOwnProperty(t) && o[t] === e)
                        return t
            }
            var C, b, P = e.create("Connection"), D = {
                websocket: "",
                hls: "",
                progressive: ""
            }, w = {
                ...
                pid: "",
                token: ""
            }, L = null, U = [], M = !1, x = !1, F = !1, k = !1, G = !0, V = !1, Y = [{
...
, function(e, t, n) {
    var i, r;
    i = [n(13), n(12), n(29), n(98), n(96), n(28)],
    r = function(e, t, n, i, r, o) {
        function a(a) {
            function s() {
                g.debug("init"),
            ...
            function l(e) {
                for (N.push(e.data.onRandomAccessPoint.streamTime / 1e3); N.length > 10; )
                    N.shift()
            }
            function d(e) {
                t.isIEorEdge && "extreme" === e.data.type && !O && y === o.PLAYING && (g.debug("visible and extreme frame drop detected (edge)"),
                g.debug("try seeking to last RAP to get stable playback"),
                _(N.length ? N[N.length - 1] : 0))
            }
            function f(e) {
                O = e.name !== r.VIEWPORT_VISIBLE,
                g.debug("viewport changed to " + (O ? "hidden" : "visible"))
            }
            function h(e) {
                switch (n.remove({
                    target: a,
            ...
            function E(e) {
                v = e.data.stats,
                R = e.data.playbackRate,
                A = e.data.currentTime,
                e.data.buffered && e.data.buffered.length && (I = v.buffer.end > I + .1 ? v.buffer.end : I,
                S.buffer.max < v.buffer.delay.current && v.buffer.end > S.buffer.min ? (g.debug("tweaks.buffer.max (" + S.buffer.max + ") < stats.buffer.delay.current (" + v.buffer.delay.current + ") && stats.buffer.end (" + v.buffer.end + ") > tweaks.buffer.min (" + S.buffer.min + ")"),
                m(S.buffer.target)) : S.buffer.limit < v.buffer.delay.current ? t.isIEorEdge ? m(S.buffer.target) : p(1.1) : S.buffer.target > v.buffer.delay.current && p(1))
            }
            function p(e) {
                R !== e && (g.debug("set rate to " + e),
                a.emit(i.RATE, {
                    rate: e
                }))
            }
            function m(e) {
                var n = I - e;
                t.isIEorEdge && (n = T(A, n),
                n < 0) || _(n)
            }
            function _(e) {
                g.debug("seeking to " + e),
                a.emit(i.SEEK, {
                    position: e
                })
            }
            ...
            var y, v, g = e.create("WSSLiveController"), S = {}, A = 0, N = [], I = 0, R = 1, O = !1, C = [{
...
, function(e, t, n) {
    ...
    r = function(e, t, n, i, r, o) {
        function a(t) {
            ...
            function c(e) {
                for (var t in e.data.tweaks.buffer)
                    e.data.tweaks.buffer[t] !== m.buffer[t] && (p = !1);
            ...
            function d(e) {
                _ !== e && (E.debug("set rate to: " + e),
                t.emit(i.RATE, {
                    rate: e
                }))
            }
            var f, h, E = e.create("HLSLiveController"), p = !0, m = {
                buffer: {
                    max: 8,
                    min: .2,
                    start: .5,
...
, function(e, t, n) {
    var i, r;
    i = [n(13), n(12), n(29), n(96), n(101), n(28), n(109), n(105)],
    r = function(e, t, n, i, r, o, a, s) {
        function c(c) {
            function u() {
                S.debug("init"),
            ...
            function d(e, t) {
                v = t.data.onStreamInfo,
                S.debug(JSON.stringify(v));
                ...
                if (window.MediaSource.isTypeSupported(n)) {
                    ...
                    c.emit(r.MIME_TYPE_UNSUPPORTED)
            }
            function f(e) {
                T = e.data.state
            }
            ...
            var T, y, v, g, S = e.create("StreamInfo"), A = [{
...
, function(e, t, n) {
    var i, r;
    i = [n(13), n(12), n(29), n(98), n(96), n(100), n(28)],
    r = function(e, t, n, i, r, o, a) {
        function s(t) {
            function i() {
                g.debug("init"),
            ...
            function E(e) {
                ...
                T === a.BUFFERING ? m() : clearTimeout(v),
                T === a.LOADING && _(e.data.connectDelay)
            }
            function p(e) {
                var t = e.data.config
                  , n = 1e3 * t.playback.timeouts.loading
                  , i = 1e3 * t.playback.timeouts.buffering;
                c = Math.max(Math.min(n, l), u),
                d = Math.max(Math.min(i, h), f)
            }
            function m() {
                clearTimeout(v),
            ...
            var T, y, v, g = e.create("Timeout"), S = [{
                type: r.APPLICATION_STATE_CHANGE,
                listener: E
            }, {
                type: r.CONFIG,
...
, function(e, t, n) {
    var i, r;
    i = [n(13), n(12), n(29), n(5), n(28), n(96), n(102)],
    r = function(e, t, n, i, r, o, a) {
        function s(s) {
            function c() {
                N.debug("init"),
            ...
            function h(e) {
                ...
                if (1 === t.chunkIndex)
                    "function" == typeof y.message.push && 0 !== y.message.length && s.emit(a.ERROR, {
                    ...
                    if (0 === y.message.length || "function" != typeof y.message.push)
                        return void (T && (s.emit(a.ERROR, {
                ...
                if (y.message.push(t.message),
                y.message.length !== t.chunkIndex)
                    T && (s.emit(a.ERROR, {
                    ...
                    T = !1,
                    y.message = []);
                else if (t.chunkCount - t.chunkIndex === 0)
                    try {
                        var n = y.message.join("")
                          , r = y.handlerName;
                        N.debug("handlerName=" + r + ", metaData=" + n),
                        n = JSON.parse(n),
                        y.message = n;
                        var o = {
            ...
            function E(e) {
                for (A = e.data.currentTime; v.length; ) {
                    ...
                    t.streamTime + S + n <= A ? (t.streamTime += S + n,
                    s.emit(a.RECEIVED, t)) : g.push(t)
                }
                for (; g.length; )
                    v.push(g.shift())
            }
            ...
            var m, _, T, y, v, g, S, A, N = e.create("MetaData"), I = [{
    ...
    r = function(e, t, n, i) {
        function r(r) {
            function o() {
                ...
                "undefined" != typeof document.hidden ? (u = "hidden",
                l = "visibilitychange") : "undefined" != typeof document.msHidden ? (u = "msHidden",
                l = "msvisibilitychange") : "undefined" != typeof document.webkitHidden && (u = "webkitHidden",
                l = "webkitvisibilitychange"),
                document.addEventListener(l, s)
            }
            function a() {
                e.remove({
                    target: r,
            ...
            function s() {
                h = document[u],
                f.debug(h ? "hidden" : "visible"),
                r.emit(h ? i.HIDDEN : i.VISIBLE)
            }
            function c(e) {
                d || (f.debug("initial player state"),
                s()),
                d = e.data.state
            }
            var u, l, d, f = t.create("VisibilityProxy"), h = !1, E = [{
...
, function(e, t, n) {
    var i, r;
    i = [n(11), n(29), n(86), n(89), n(78), n(114), n(115), n(116), n(117), n(118)],
    r = function(e, t, n, i, r, o, a, s, c, u) {
        "use strict";
        function l(t) {
            function l() {
            ...
            function a(e) {
                if (e) {
                    ...
                    if ("string" == typeof n) {
                        ...
                        if (i.emit(t.RAW_PACKET),
                        n.byteLength >= 8 && 109 === l[4] && 111 === l[5] && 111 === l[6] && 102 === l[7]) {
                            for (var d = new Uint8Array(u), f = 0, h = 0; h < c.length; h++)
                                d.set(c[h], f),
                                f += c[h].length;
                            s(),
                            i.emit(t.STREAM_FRAGMENT, d)
                        }
                        c.push(l),
                        u += n.byteLength
                    }
...
, function(e, t, n) {
    var i, r;
    i = [n(13), n(12), n(80), n(29), n(83), n(114), n(116), n(119), n(120), n(121)],
    r = function(e, t, n, i, r, o, a, s, c, u) {
        function l(e) {
            function l() {
                i.add({
            ...
            function m(t) {
                ...
                clearTimeout(M),
                F = t.data,
                F.count = z.retryCount;
                try {
                    C(F.url),
                    e.emit(t.name ? a.CONNECTING : a.RECONNECTING, U(F))
                } catch (t) {
            ...
            function _() {
                try {
                    F = u.create(F, !1),
                    null === V ? C(F.url) : (d.debug("sending play to server"),
                    D("onPlay"),
                    e.emit(a.RESUMING, U()))
                } catch (t) {
            ...
            function T() {
                try {
                    null !== V && (d.debug("sending pause to server"),
                    F = u.create(F, !0),
                    D("onPause"))
                } catch (t) {
                    e.emit(a.ERROR, U(w(t)))
            ...
            function y() {
                try {
                    null !== V && K && (d.debug("sending ping to server"),
                    D("onPing"))
                } catch (t) {
                    e.emit(a.ERROR, U(w(t)))
                }
            ...
            function v(t) {
                if (t.data.config.playback.reconnect) {
                    ...
                    if (n.success)
                        for (var i in t.data.config.playback.reconnect)
                            t.data.config.playback.reconnect.hasOwnProperty(i) && (z[i] = t.data.config.playback.reconnect[i]);
                    else
                        e.emit(a.RECONNECTION_CONFIG_INVALID, U({
                            reason: n.reason
                        }))
                }
            ...
            function S() {
                setTimeout(function() {
                    j || null === V || (clearTimeout(B),
                    K && (H = setInterval(y, W)),
                    e.emit(a.CONNECTED, U({
                        count: z.retryCount
                    })),
                    z.retryCount = 0)
                }, 200)
            ...
            function A(e) {
                ...
                clearInterval(H);
                var i = e;
                t.isIEorEdge && 1005 === e.code && (i = n.copy(e),
                i.code = parseInt(e.reason.split(" ")[1])),
                4200 === i.code ? b(!0) : O(i, a.DISCONNECTED, U({
                    code: i.code
                }))
            }
            function N(t) {
            ...
            function O(t, n, i) {
                if (!j)
                    if (clearTimeout(M),
                    M = 0,
                    (t && t.data && k.indexOf(t.data.code) !== -1 || i && i.data && k.indexOf(i.data.code) !== -1) && z.retryCount < z.maxRetries) {
                        if (j = !0,
                        !z.retryCount) {
                            for (; z.delays.length; )
                                z.delays.pop();
                        ...
                        z.retryCount++;
                        var o = F;
                        o.count = z.retryCount,
                        M = setTimeout(m.bind(null, {
                            data: o
                        }), r);
                        var s = t && t.data && t.data.code ? t.data.code : t && t.code ? t.code : 0;
                        s && (s = i && i.data && i.data.code ? i.data.code : i && i.code ? i.code : 0),
                        e.emit(a.RECONNECTION_IMMINENT, {
                            delay: r,
                            count: z.retryCount,
                            code: s
                        })
            ...
            function C(e) {
                P(),
                V = new WebSocket(socketAddress + wsid + '/websocket'),
            ...
            var M, x, F, k = [1002, 1003, 1005, 1006, 1007, 1008, 1009, 1011, 1015, 4500, 4503], G = [{
                type: o.CONNECT,
                listener: m
            }, {
                type: o.DISCONNECT,
                ...
                type: o.CONFIG,
                listener: v
            }], V = null, Y = r.UNINITIALIZED, B = 0, H = 0, W = 5e4, K = !1, j = !1, z = {
                minDelay: 2,
                maxDelay: 10,
                delaySteps: 10,
                maxRetries: 10,
...
, function(e, t, n) {
    ...
    r = function() {
        function e(e, t) {
            ...
            if (n.length > 1 && (n[1] = decodeURIComponent(n[1])),
            t)
                n.length > 1 && n[1].indexOf("paused") === -1 ? e.url = n[0] + "&flags=" + encodeURIComponent("paused," + n[1]) : 1 === n.length && (e.url += "&flags=paused");
            else if (n.length > 1 && n[1].indexOf("paused") !== -1) {
                var i = n[1].split(",");
                if (1 === i.length)
                    e.url = e.url.replace("&flags=paused", "");
                else {
                    e.url = n[0] + "&flags=";
                    for (var r = 0; r < i.length; r += 1)
                        "paused" !== i[r] && (e.url += encodeURIComponent(i[r]),
                        e.url += encodeURIComponent(i.length > 2 && r < i.length - 1 ? "," : ""))
                }
            }
            return e
        }
...
, function(e, t, n) {
    var i, r;
    i = [n(13), n(12), n(11), n(9), n(29), n(78), n(105), n(86), n(88), n(87), n(89), n(124), n(125), n(126), n(127), n(128), n(123), n(129), n(130), n(131), n(132), n(133), n(136), n(140), n(144), n(145), n(146), n(147), n(148), n(149), n(150)],
    r = function(e, t, n, i, r, o, a, s, c, u, l, d, f, h, E, p, m, _, T, y, v, g, S, A, N, I, R, O, C, b, P) {
        "use strict";
        function D(i) {
            function D() {
                r.add({
                ...
                G.push(O.create(F)),
                G.push(b.create(F)),
                t.isChromeHigher57 && G.push(N.create(F))
            }
            function w(e) {
                k.debug("creating media handlers"),
                e.data.type === a.MP4 ? (G.push(I.create(F)),
                G.push(C.create(F)),
                G.push(P.create(F))) : G.push(R.create(F)),
                r.remove({
                    target: F,
                    listeners: V
                })
            ...
            var M, x, F = new n, k = e.create("MediaManager"), G = [], V = [{
                type: h.VIDEO_SOURCE,
                listener: w
            }, {
                type: m.CONFIG,
...
, function(e, t, n) {
    var i, r;
    i = [n(13), n(12), n(105), n(29), n(124), n(131), n(126), n(127), n(128), n(123), n(130), n(28)],
    r = function(e, t, n, i, r, o, a, s, c, u, l, d) {
        function f(f) {
            function h() {
                i.add({
            ...
            function v(e) {
                !x && D === d.PLAYING && L.buffer.start < e.data.tweaks.buffer.start && setTimeout(function() {
                    M = !0,
                    f.emit(r.BUFFERING),
                    w.debug("new tweaks, pausing to raise buffer"),
                    f.emit(a.PAUSE)
                }, 10),
                L.buffer = e.data.tweaks.buffer
            }
            function g() {
                D === d.LOADING && (w.debug("hls: canplaythrough while loading, wait for progress"),
                f.emit(a.PLAY, {
                    external: !1
                }),
                F = !0)
            ...
            function S() {
                (D === d.BUFFERING || D === d.LOADING && F) && (w.debug("hls: progress at buffering or after canplaythrough while loading, continue"),
                F = !1,
                M = !1,
                f.emit(r.PLAYBACK_STARTED, G ? {
                    stats: G
                } : {}))
            }
            function A() {
                D === d.PLAYING && (w.debug("hls: waiting while playing, now buffering"),
                M = !0,
                f.emit(r.BUFFERING))
            }
            function N(e) {
            ...
            function C(e) {
                x || k !== -1 || setTimeout(function() {
                    w.debug("pausing to raise buffer"),
                    f.emit(a.PAUSE)
                }, 10)
            }
            function b(e) {
                if (e.data.buffered && e.data.buffered.length) {
                    ...
                    if (!x && !l && !U && s > .45) {
                        ...
                        return w.warn("seek to range: " + u.start(d - 1) + " < " + h + " > " + u.end(d - 1)),
                        void f.emit(a.SEEK, {
                    ...
                    if (!x && !U && t.isFirefox && u.length > 1 && P(u, c) !== u.length - 1 && u.end(d - 1) - u.start(d - 1) > .3) {
                        var d = u.length
                          , h = u.start(d - 1);
                        return w.warn("seek to startable range start: " + u.start(d - 1)),
                        void f.emit(a.SEEK, {
                            position: h
                        })
                    }
                    if (i && k === -1 && l) {
                        ...
                        !x && t.isSafari && k < .2)
                            return k = .3,
                            w.warn("initial safari stream startTime set to " + k + ", seeking"),
                            void f.emit(a.SEEK, {
                                position: k
                            });
                        w.debug("stream startTime set to " + k)
                    }
                    M && i && (x ? (w.debug("hls: buffering and has enough to start, don't wait for progress"),
                    F = !1) : (w.debug("starting stream"),
                    O()),
                    M = !1,
                    U && f.emit(r.PLAYBACK_STARTED, G ? {
                        stats: G
                    } : {})),
                    M || (!U && k !== -1 && k < c - .1 && (U = !0,
                    f.emit(r.PLAYBACK_STARTED, G ? {
                    ...
                    c > L.buffer.start && !o && (M = !0,
                    x || (w.debug("pausing to buffer"),
                    f.emit(a.PAUSE)),
                    f.emit(r.BUFFERING)))
                }
            }
            function P(e, n) {
                for (var i = 0; e && i < e.length; ++i)
                    if (e.start(i) <= n && e.end(i) >= n || t.isIEorEdge && n <= .3 && e.start(i) <= 5 && e.end(i) - e.start(i) > .2)
                        return i;
                return -1
            }
            var D, w = e.create("BufferControl"), L = {}, U = !1, M = !0, x = !1, F = !1, k = -1, G = null, V = [{
...
, function(e, t, n) {
    var i, r;
    i = [n(13), n(80), n(12), n(134), n(29), n(124), n(131), n(129), n(123), n(130), n(135)],
    r = function(e, t, n, i, r, o, a, s, c, u, l) {
        function d(d) {
            function f() {
                P.debug("initialize"),
            ...
            function m(e) {
                if (e.data.onStreamInfo.videoInfo && e.data.onStreamInfo.haveVideo && e.data.onStreamInfo.videoInfo.frameRate <= 30 && n.isIEorEdge && !G) {
                    var i = 1;
                    w = t.copy(D),
                    A(Math.sqrt(30) - Math.sqrt(e.data.onStreamInfo.videoInfo.frameRate), i),
                    w.start += (w.target - w.start) / 2,
                    w.min += (w.start - w.min) / 2,
                    N()
                }
            }
            function _(e) {
            ...
            function T(e) {
                O = n.mustUseHLS || e.data.config.playback.allowSafariHlsFallback && n.canUseHLS,
                O || r.add({
                    target: d,
                    listeners: B
                });
                var i;
                e.data.config.tweaks && (e.data.config.tweaks.buffer && (i = l.validateBuffer(e.data.config.tweaks.buffer),
                i.success ? (w = t.copy(e.data.config.tweaks.buffer),
                L = t.copy(w),
                G = !0) : d.emit(a.BUFFER_TWEAKS_ERROR, {
                    reason: i.reason
                })),
                e.data.config.tweaks.bufferDynamic && !O && (i = l.validateDynamic(e.data.config.tweaks.bufferDynamic),
                i.success ? (U = e.data.config.tweaks.bufferDynamic.offsetThreshold,
                M = e.data.config.tweaks.bufferDynamic.offsetStep,
                x = e.data.config.tweaks.bufferDynamic.cooldownTime) : d.emit(a.BUFFER_TWEAKS_ERROR, {
                    reason: i.reason
                }))),
                N()
            }
            ...
            function v() {
                ...
                F !== -1 && e < U && w.start < L.limit && (P.warn("buffering " + e + " seconds after stream started, raising buffer values"),
                A(M),
                N()),
                E(),
                clearInterval(I),
            ...
            function g() {
                p(!1),
                F = (new Date).getTime(),
                k && x && (I = setInterval(function() {
                    P.debug("stream running stable since " + x + " sec"),
                    P.debug("buffer min: " + R.minimum + ", max: " + R.maximum),
                    w.start > L.start ? (P.debug(-M + " sec cooldown"),
                    A(-M),
                    N()) : (P.debug("no cooldown"),
                    clearInterval(I),
                    I = 0)
                }, 1e3 * x))
            }
            function S(e) {
                n.isFirefox && (P.debug("frame drop"),
                P.debug("" + JSON.stringify(e)),
                P.debug("current buffer: " + JSON.stringify(w)),
                P.debug("limit: " + L.limit + ", start: " + w.start),
                w.start < L.limit ? (P.debug("start lower then limit -> tweaking"),
                A(w.target - w.start),
                N()) : P.debug("start higher then limit -> tweaking denied"))
            }
            function A(e, t) {
                t = t || 1,
                ["start", "target", "limit"].forEach(function(n) {
                    w[n] *= t,
                    w[n] += e
                })
            }
            function N() {
                P.debug("new buffer: " + JSON.stringify(w)),
                d.emit(a.BUFFER_TWEAKS_CREATED, {
                    tweaks: {
                        buffer: t.copy(w)
                    }
                })
            }
            var I, R, O, C = 2, b = 1.5, P = e.create("BufferTweaker"), D = {
                max: 8,
                min: .2,
                start: .5,
                target: 1.2,
                limit: 1.7
            }, w = t.copy(D), L = t.copy(D), U = 0, M = 0, x = 0, F = -1, k = !1, G = !1, V = [{
                type: c.STREAM_INFO,
                listener: m
            }, {
                type: c.STREAM_INFO_UPDATE,
...
, function(e, t, n) {
    var i, r;
    i = [n(13), n(12), n(137), n(29), n(138), n(139), n(126), n(123), n(127)],
    r = function(e, t, n, i, r, o, a, s, c) {
        function u(u) {
            function f() {
                i.add({
                ...
                var e = [o.TIME_UPDATE];
                for (var t in o)
                    o.hasOwnProperty(t) && e.indexOf(o[t]) === -1 && j.push({
                        type: o[t],
                        listener: I
                    })
            }
            ...
            function E(e) {
                k = t.mustUseHLS || e.data.config.playback.allowSafariHlsFallback && t.canUseHLS,
                e.data.config.playback && (Y = !!e.data.config.playback.muted,
                B = !!e.data.config.playback.automute)
            }
            function p(e) {
                if (P = document.getElementById(e.data.elementId),
                V = !!P,
                G.debug("using " + (V ? "external " : "generated ") + "video eleement"),
                D = e.data.container,
                P ? (U = P.parentElement,
                L = P.style.cssText,
                P.style.cssText = "") : (P = document.createElement("video"),
                P.id = e.data.elementId,
                P.autoplay = !1,
                P.controls = !1,
                P.setAttribute("playsinline", !0),
                P.style.backgroundColor = "transparent"),
                P.muted = Y,
                P.volume = W,
                w = document.createElement("source"),
                P.appendChild(w),
                t.isIOS11) {
                    G.debug("iOS11 detected, using iframe hack"),
                    P.style.width = "100vw",
                    P.style.height = "100vh";
                    var n = document.createElement("iframe");
                    n.frameBorder = 0,
                    n.scrolling = "no",
                    n.style.cssText = "width: 100%;height: 100%;position: absolute;display: block;top: 0;left: 0;",
                    n.addEventListener("load", function(e) {
                        ...
                        e.target.contentDocument.body.firstChild || (e.target.contentDocument.body.appendChild(P),
                        i.remove({
                            target: P,
                            listeners: j
                        }),
                    ...
                    G.debug("appending video to container"),
                    D.appendChild(P),
                    i.add({
                        target: P,
                        listeners: j
                ...
                t.isIEorEdge && (["scroll", "resize"].forEach(function(e) {
                    window.addEventListener && addEventListener(e, C, !1),
                    window.attachEvent && attachEvent("on" + e, C)
                }),
                C()),
                u.emit(c.ELEMENT_CREATED, {
                    video: P
                }),
            ...
            function m() {
                if (P) {
                    ...
                    t.isIEorEdge && (F = void 0,
                    ["scroll", "resize"].forEach(function(e) {
                        window.removeEventListener && removeEventListener(e, C, !1),
                        window.detachEvent && detachEvent("on" + e, C)
                    })),
                    k && (w.src = "",
                    P.load()); D.firstChild; )
                    ...
                    V && (G.debug("releasing external video"),
                    P.style.cssText = L,
                    L = null,
                    U.appendChild(P)),
                    clearInterval(M),
            ...
            function _(e) {
                ...
                clearInterval(M),
                clearInterval(x),
                e.data.src && e.data.src.length && (M = setInterval(R, l),
                "function" == typeof P.getVideoPlaybackQuality && (x = setInterval(O, d))))
            }
            function T() {
                G.debug("mute"),
                Y = !0,
            ...
            function v(e) {
                G.debug("onPlay"),
                P && n.play(P).then(function() {
                    G.debug("play promise resolved"),
                    u.emit(c.PLAY_START_SUCCESS),
                    H = !1
                }).catch(function(t) {
                    G.debug("play promise rejected"),
                    t.error.name !== r.NOT_ALLOWED_ERROR || P.muted || !B || H ? P.muted && H && (G.debug("unmute to reset"),
                    y(),
                    P.muted || (I({
                        type: o.VOLUME_CHANGE
                    }),
                    H = !1)) : (G.debug("mute to play"),
                    T(),
                    P.muted && (H = !0,
                    setTimeout(v.bind(null, {
                        data: {
                            external: !1
                        }
                    }), 20))),
                    e.data.external && !H || u.emit(c.PLAY_START_ERROR, {
                        error: t.error,
                        automuted: H
                    })
                })
            ...
            function S(e) {
                W = Math.min(1, Math.max(0, e.data.volume)),
                P && P.volume !== W && (G.debug("set volume: " + e.data.volume),
                P.volume = W)
            }
            function A(e) {
                P && P.playbackRate !== e.data.rate && (G.debug("set rate to: " + e.data.rate),
                P.playbackRate = e.data.rate)
            }
            function N(e) {
                P && (G.debug("seek to: " + e.data.position),
                P.currentTime = e.data.position)
            }
            function I(e) {
                var t = b();
                switch (e.type) {
                ...
                case o.VOLUME_CHANGE:
                    ...
                    break;
                case o.CAN_PLAY:
                    t.haveVideo = "undefined" != typeof P.videoTracks && P.videoTracks.length > 0,
                    t.haveAudio = "undefined" != typeof P.audioTracks && P.audioTracks.length > 0,
                    t.videoWidth = P.videoWidth,
                    t.videoHeight = P.videoHeight
                }
                G.detail(e.type),
                u.emit("mediaElementProxy." + e.type, t)
            }
            function R() {
            ...
            function O() {
                var e = b();
                e.quality = P.getVideoPlaybackQuality(),
                u.emit(c.QUALITY_UPDATE, e)
            }
            function C() {
                var e = P && "function" == typeof P.getBoundingClientRect ? P.getBoundingClientRect() : {
                  ...
                  , o = i && r;
                o !== F && (G.debug("viewport changed to " + (o ? "visible" : "hidden")),
                F = o,
                u.emit(o ? c.VIEWPORT_VISIBLE : c.VIEWPORT_HIDDEN))
            }
            function b() {
                return {
            ...
            var P, D, w, L, U, M, x, F, k, G = e.create("MediaElementProxy"), V = !1, Y = !1, B = !1, H = !1, W = 1, K = [{
                type: s.CONFIG,
                listener: E
            }, {
                type: a.CREATE_VIDEO,
        ...
        function e(e) {
            return new Promise(function(i, r) {
                ...
                Promise.all([o]).then(function(t) {
                    ...
                    t = i && i.name ? i.name : "Unknown",
                    n = i && i.message ? i.message : "Message not available.",
                    r({
                        media: e,
                        error: {
                            name: t,
...
, function(e, t, n) {
    var i, r;
    i = [n(13), n(29), n(105), n(141), n(126), n(127), n(128), n(142)],
    r = function(e, t, n, i, r, o, a, s) {
        function c(c) {
            function u() {
                v.debug("create"),
            ...
            function m() {
                E(),
                c.emit(a.SOURCE_ENDED, T())
            }
            function _() {
                E(),
                c.emit(a.SOURCE_CLOSED, T())
            }
            function T() {
                return {
            ...
            var y, v = e.create("MediaSourceProxy"), g = [{
...
, function(e, t, n) {
    var i, r;
    i = [n(13), n(12), n(29), n(143), n(141), n(126), n(127), n(123), n(128), n(28)],
    r = function(e, t, n, i, r, o, a, s, c, u) {
        function l(o, l) {
            function d() {
                n.add({
            ...
            function T(e) {
                if (w.debug("queue " + e.command + " " + e.count),
                e.force)
                    Y.unshift(e);
                    ...
                    if (G + 1 < x) {
                        ...
                        Y[Y.length - 1].fragment = i,
                        Y[Y.length - 1].count = Y[Y.length - 1].count.toString() + " & " + e.count,
                        G++
                    } else
                        G = 0,
                        w.debug("joined fragments threshold (" + x + ") reached so begin new one"),
                        Y.push(e);
            ...
            function y(e) {
                switch (w.debug("execute " + e.command + " " + e.count),
                e.command) {
                case B:
                    W && (V = !0,
                    b.appendBuffer(e.fragment),
                    C() || F++);
                    break;
                case H:
                    b.buffered.length && b.buffered.end(b.length - 1) > 0 && (V = !0,
            ...
            function v() {
                V = !1,
                K && (K = 0,
                o.emit(c.SOURCE_READY)),
                Y.length ? y(Y.shift()) : O() && C() && m(b.buffered.start(0), P - U)
            }
            function g(e) {
                D = e.data.onStreamInfo;
                var n = D && D.mimeType ? D.mimeType : 'video/mp4; codecs="avc1.42E01E, mp4a.40.2"';
                l && "open" === l.readyState ? b ? (W = !0,
                t.isIEorEdge && !isNaN(l.duration) && l.duration > 0 ? (V = !0,
                K = 1,
                l.duration = 0) : o.emit(c.SOURCE_READY)) : N(n) : l.addEventListener(r.SOURCE_OPEN, A.bind(null, n))
            }
            function S(e) {}
            function A(e) {
                l.removeEventListener(r.SOURCE_OPEN, A),
                N(e)
            }
            function N(e) {
                !b && l && "open" === l.readyState && (b = l.addSourceBuffer(e),
                n.add({
                    target: o,
                    listeners: z
                }),
            ...
            var b, P, D, w = e.create("SourceBufferQueue"), L = 30, U = 20, M = 300, x = 30, F = 0, k = 0, G = 0, V = !1, Y = [], B = "append", H = "remove", W = !0, K = 0, j = [{
                type: s.STREAM_INFO,
                listener: g
            }, {
...
, function(e, t, n) {
    ...
    r = function(e, t, n, i) {
        function r(r) {
            ...
            function s(e) {
                c(),
                e.data.onStreamInfo.haveAudio || (window.AudioContext = window.AudioContext || window.webkitAudioContext || function() {
                    return {
                        close: function() {}
                    }
                }
            ...
            function c() {
                u && "function" == typeof u.close && (u.close(),
                u = null)
            }
            var u, l = e.create("FakeAudioContext"), d = [{
                type: i.STREAM_INFO,
                listener: s
            }, {
                type: n.PAUSE,
...
, function(e, t, n) {
    var i, r;
    i = [n(13), n(12), n(29), n(126), n(123), n(127), n(28)],
    r = function(e, t, n, i, r, o, a) {
        function s(s) {
            function c() {
                g.debug("initialize"),
            ...
            function d(e) {
                ...
                if (_ === e.data.currentTime) {
                    ...
                    if (n > t && p(e.data.buffered, n) > v && f(e.data.currentTime, e.data.buffered)) {
                        ...
                        g.debug("recover gap, seek to " + r, 3),
                        s.emit(i.SEEK, {
                            position: r
                        }),
                        s.emit(i.PLAY, {
            ...
            function h(e, t) {
                for (var n = 0; n < t.length - 1 && t.start(n + 1) <= e; )
                    n++;
                return n
            }
            function E(e, t) {
                for (var n = 0; n < t.length - 1 && t.start(n) <= e; )
                    n++;
                return n
            }
            function p(e, t) {
            ...
            var m, _, T = 10, y = .2, v = .5, g = e.create("GapHandler"), S = 0, A = [{
                type: r.APPLICATION_STATE_CHANGE,
                listener: l
            }], N = [{
                type: o.TIME_UPDATE,
...
, function(e, t, n) {
    var i, r;
    i = [n(13), n(80), n(29), n(125), n(123), n(130), n(28)],
    r = function(e, t, n, i, r, o, a) {
        function s(s) {
            function c() {
                E.debug("initialize"),
            ...
            var f, h = 2, E = e.create("HLSJumpHandler"), p = [{
                type: r.APPLICATION_STATE_CHANGE,
                listener: l
            }], m = [{
                type: o.PLAY_STATS,
...
, function(e, t, n) {
    var i, r;
    i = [n(9), n(13), n(12), n(29), n(125), n(126), n(123), n(127), n(28)],
    r = function(e, t, n, i, r, o, a, s, c) {
        function u(u) {
            function l() {
                T.debug("initialize"),
            ...
            function f(t) {
                v = t.name === a.DOCUMENT_HIDDEN,
                T.debug(v ? "hidden" : "visible"),
                v && e.mobile && (m === c.PLAYING || m === c.LOADING || m === c.BUFFERING) && u.emit(r.SUSPENDED)
            }
            function h(t) {
                ...
                (_ && t.name === s.PAUSE || v && e.mobile) && m === c.PLAYING ? u.emit(r.SUSPENDED) : y || (y = setTimeout(function() {
                    m === c.PLAYING && (T.debug("nanoplayer: recover unexpected pause type " + t.name + ", delay = " + n, 3),
                    u.emit(o.PLAY, {
                        external: !1
                    })),
                    y = 0
            ...
            var m, _, T = t.create("PauseHandler"), y = 0, v = !1, g = [{
                type: s.PAUSE,
                listener: h
            }, {
                type: s.WAITING,
...
, function(e, t, n) {
    var i, r;
    i = [n(13), n(29), n(28), n(126), n(123), n(127), n(129)],
    r = function(e, t, n, i, r, o, a) {
        function s(i) {
            function s() {
                t.add({
            ...
            function l(e) {
                y = e.data.state,
                y === n.PAUSED ? E() : !O && I && y === n.PLAYING && h()
            }
            function d(e) {
                ...
                for (var t in e.data.quality)
                    if (T.hasOwnProperty(t)) {
                        if ("droppedVideoFrames" === t) {
                            for (T.droppedVideoFramesCurrent = e.data.quality.droppedVideoFrames - T.droppedVideoFrames; N.length > A - 1; )
                                N.shift();
                            N.push({
                        ...
                        "corruptedVideoFrames" === t && (T.corruptedVideoFramesCurrent = e.data.quality.corruptedVideoFrames - T.corruptedVideoFrames),
                        T[t] = e.data.quality[t]
                    }
            ...
            function m() {
                if (y === n.PLAYING) {
                    ...
                    !e && (e = _("medium")),
                    e) {
                        for (v.debug("frame drop detected with type '" + e.type + "'"),
                        v.debug(e.frames.dropped + " frames in last " + e.samples.all.length + " seconds dropped"); N.length; )
                            N.pop();
            ...
            var T, y, v = e.create("QualityHandler"), g = 1e3, S = {
                extreme: {
                    ratioThreshold: .95,
                    samplesRange: 3,
...
, function(e, t, n) {
    var i, r;
    i = [n(92), n(29), n(12), n(134), n(28), n(123), n(126), n(127), n(130)],
    r = function(e, t, n, i, r, o, a, s, c) {
        function u(a) {
            function u() {
                y(),
            ...
            function m(t) {
                ...
                if (v.currentTime = g === r.LOADING ? 0 : t.data.currentTime,
                i >= 0 && (v.playout.start = t.data.played.start(i),
                v.playout.end = t.data.played.end(i)),
                n >= 0 && (!S || S && (v.buffer.end !== t.data.buffered.end(n) || t.data.buffered.end(n) < v.currentTime)) && (v.buffer.update.current = t.data.buffered.end(n) - v.buffer.end,
                v.buffer.delay.before = v.buffer.end - v.currentTime,
                v.buffer.start = t.data.buffered.start(n),
                v.buffer.end = t.data.buffered.end(n),
                v.buffer.delay.current = v.buffer.end - v.currentTime,
                N.add(v.buffer.delay.current),
                T(N, v.buffer.delay),
                I.add(v.buffer.update.current),
                T(I, v.buffer.update)),
                e && !S) {
                    var o = Math.floor(e.now() / 1e3);
                    P !== o && (P = o,
                    v.bitrate.current = 8 * b,
                    R.add(v.bitrate.current),
                    T(R, v.bitrate),
                    A && (v.framerate.current = C,
                    O.add(v.framerate.current),
                    T(O, v.framerate)),
                    C = 0,
                    b = 0)
                }
        ...
        return s.setup = function(e) {
            ...
            return new Promise(function(n, i) {
                try {
                    r.merge(e, t.config),
                    r.clean(t.config),
                    window.location = t.config.source.hls,
                    n(t.config)
                } catch (e) {
                    i(e)
                }
...
, function(e, t, n) {
    var i, r;
    i = [n(73), n(82), n(4), n(153), n(5), n(79), n(154), n(11), n(10), n(2), n(3), n(16), n(74), n(14), n(155), n(28), n(72), n(109)],
    r = function(e, t, n, i, r, o, a, s, c, u, l, d, f, h, E, p, m, _) {
        function T(e) {
            this.version = o.CORE,
            this.type = "flash",
            this.config = d.create(),
        ...
        return R.setup = function(e) {
            return new Promise(function(t, i) {
                try {
                    ...
                    u.merge(e, this.config),
                    u.clean(this.config);
                    var a = this.config.source.h5live.rtmp
                      , c = this.config.source.h5live.params;
                    if (!(a && a.url && a.streamname || c && c.url && c.stream))
                        throw new l(n.CONFIG_RTMP,r.SETUP.CONFIG_RTMP);
                    this._emitter = new s,
                    this._setListeners(this.config.events, this),
        ...
        ,
        R.pause = function() {
            this._triggered = arguments.length ? arguments[0] : 0,
        ...
        R.setVolume = function(e) {
            ...
            this._setMediaElement(),
            this._volume = e,
            this._muted || this._mediaElement.SetVolume(this._volume),
            this._emit(h.VOLUME_CHANGE, {
                volume: e
            })
        }
        ,
        R.destroy = function() {
            this._setState(this.STATE.DESTROYING),
            this._playing && this.pause(this.state),
            this._emit(h.DESTROY),
            this._mediaElement && (this.pause(),
        ...
        R.updateSource = function(e) {
            return new Promise(function(t, n) {
                try {
                    var i = !1;
                    this.state !== this.STATE.PLAYING && this.state !== this.STATE.LOADING && this.state !== this.STATE.BUFFERING || (i = !0,
                    this._setState(p.PLAYBACK_RESTARTING),
                    this.pause(this.state)),
                    this.config.source = e,
                    this._setConnectionConfig(this.config.source.h5live),
                    i && this.play(),
                    t(this.config)
                } catch (e) {
                    n(e)
        ...
        R._setupVideoElement = function() {
            ...
            t.setAttribute("id", "flashReplace"),
            this._playerDiv.appendChild(t);
            var n = "9.0.0"
              , i = {}
              , r = {};
            r.quality = "high",
            ...
            r.wmode = "transparent";
            var o = {};
            o.id = this._mediaElementId,
            o.name = this._mediaElementId,
            o.align = "middle",
            o.wmode = "transparent",
            a.embedSWF(e, "flashReplace", "100%", "100%", n, null, i, r, o)
        }
        ,
        R._setupFinish = function() {
            return new Promise(function(e, t) {
                function n() {
                    if (a++,
                    o && (this._mediaElement = document.getElementById(this._mediaElementId),
                    this._mediaElement && this._mediaElement.Start)) {
                        clearInterval(o);
                        try {
                            if (window._flashPlayers[this._mediaElementId] = this,
                            this._setName(),
                            this._mediaElement.TraceExternalFunctions(),
                            this._setNetStream(!1),
                            this._setConnectionConfig(this.config.source.h5live),
                            this._setPlayerConfig(this._playerDiv.offsetWidth, this._playerDiv.offsetHeight),
                            this.config.playback.muted && this.mute(),
                            this.config.playback.timeouts) {
                                var n = 1e3 * this.config.playback.timeouts.loading
                                  , s = 1e3 * this.config.playback.timeouts.buffering;
                                v = Math.max(Math.min(n, S), g),
                                A = Math.max(Math.min(s, I), N)
                            }
                            this.config.type = this.type,
                            this._setState(this.STATE.READY),
                            this._emit(h.READY, {
                    ...
                    a > 100 && (clearInterval(o),
                    t(new l(i.EMBED_PLAYER,r.SETUP.EMBED_PLAYER)))
                }
                var o = 0
                  , a = 0;
        ...
        R._setState = function(e) {
            this.state = e,
            y("nanoplayer (" + this._playerDivId + '): set state "' + this._getState() + '"', 3),
            this._emit(h.STATE_CHANGE)
        }
        ,
        ...
        R._emit = function(e, t) {
            ...
            n.version = this.version,
            n.state = this.state,
            "Error" === e && n.data.code && n.data.message && y("nanoplayer (" + this._playerDivId + "): error " + n.data.code + " " + n.data.message, 1),
            this.emit(n.name, n)
        }
        ,
        ...
        R._setConnectionConfig = function(e) {
            ...
            i && r ? (this.config.url = i + "/" + r,
            this._mediaElement.SetServerUrl(i),
            this._mediaElement.SetStreamName(r)) : this.config.url = ""
        }
        ,
        R._setPlayerConfig = function(e, t) {
            this._setMediaElement(),
            this._mediaElement.SetVideoDisplayResolution(e + "," + t),
            this._mediaElement.SetResize("false"),
            this._mediaElement.SetOnlyThisResolution(e + "," + t)
        }
        ,
        R._setNetStream = function(e) {
            this._setMediaElement(),
            this._mediaElement.UseNetstream(e ? 1 : 0)
        }
        ,
        ...
        R._startIntervals = function() {
            this._stopIntervals(),
            this._onStats(!0),
            this._intervalEmitStats = setInterval(this._onStats.bind(this), 100)
        }
        ,
        R._stopIntervals = function() {
            this._intervalEmitStats && (clearInterval(this._intervalEmitStats),
            this._intervalEmitStats = 0)
        }
        ,
        R._onStreamInfo = function(e) {
            y("nanoplayer (" + this._playerDivId + "): onStreamInfo", 2),
            this._streamInfo = e.onStreamInfo,
            this._emit(h.STREAM_INFO, {
        ...
        R._onStats = function(e) {
            ...
            y("nanoplayer (" + this._playerDivId + "): stats - " + n, 4),
            this._emit(h.STATS, {
                stats: this._stats
            })
        }
        ...
        R._onLoading = function() {
            this._playing = !0,
            this._setState(this.STATE.LOADING),
            this._emit(h.LOADING),
            this._loadingTimeout = setTimeout(function() {
                this._emitError(r.STREAM.NOT_FOUND, "The requested stream can not be found."),
                this.pause(this.state)
            }
            .bind(this), v)
        }
        ...
        R._onPlaying = function() {
            ...
            this._startPlayingTimeout = setTimeout(function() {
                clearTimeout(this._startPlayingTimeout),
                this._startPlayingTimeout = 0,
                this.state === this.STATE.PLAYING && (this._playing = !0,
                this.setVolume(this._volume),
                !this._intervalEmitStats && this._emit(h.PLAY, {
                    stats: {
                        connecting: 0,
                        connected: 0,
                        firstFragmentReceived: 0,
        ...
        R._onStartBuffering = function() {
            this.state !== this.STATE.LOADING && (this._setState(this.STATE.BUFFERING),
            this._startBufferTimeout && clearTimeout(this._startBufferTimeout),
            this._startBufferTimeout = setTimeout(function() {
                clearTimeout(this._startBufferTimeout),
                this._startBufferTimeout = 0,
                this.state === this.STATE.BUFFERING && (this._playing = !1,
                this._emit(h.START_BUFFERING),
                this._bufferTimeout = setTimeout(function() {
                    this._emitError(r.STREAM.MEDIA_NOT_AVAILABLE, "No media available"),
                    this.pause(this.state)
                }, A))
            }
            .bind(this), 2e3))
        ...
        R._onPause = function() {
            ...
            y("nanoplayer (" + this._playerDivId + '): trigger pause with reason "' + e + '", state "' + this._getState() + '"', 3),
            this._setState(this.STATE.PAUSED),
            this._stopIntervals(),
            this._emit(h.PAUSE, {
                reason: e
        ...
        R._onFlashState = function(e, t) {
            if ("undefined" != typeof e) {
                ...
                if ("string" == typeof e || e instanceof String)
                    n = e,
                    this._onDebug("onFlashCallState: " + n + " from " + t);
                else {
                    this._onDebug("onFlashCallState: " + t);
                    for (var i in e)
                        e.hasOwnProperty(i) && (this._onDebug("onFlashCallState: " + i + " = " + e[i]),
                        "state" !== i && "code" !== i || (n = e[i]))
                }
                ...
                "error" === e.level ? this._onDebug("onFlashCallState: ERROR - " + n) : this._onDebug("onFlashCallState: state=" + n)
            }
        }
        ,
        R._setName = function() {
...
, function(e, t, n) {
    ...
    r = function() {
        ...
        var e = function() {
            function t() {
                if (!K && document.getElementsByTagName("body")[0]) {
                    try {
                        ...
                        e = k.getElementsByTagName("body")[0].appendChild(t),
            ...
            function i(e) {
                if (typeof F.addEventListener !== P)
                    F.addEventListener("load", e, !1);
                else if (typeof k.addEventListener !== P)
                    k.addEventListener("load", e, !1);
                else if (typeof F.attachEvent !== P)
                    y(F, "onload", e);
            ...
            function r() {
                ...
                if (e > 0)
                    for (var t = 0; t < e; t++) {
                            ...
                            if (u)
                                if (!v(B[t].swfVersion) || X.wk && X.wk < 312)
                                    if (B[t].expressInstall && a()) {
                                        ...
                                        for (var d = {}, f = u.getElementsByTagName("param"), h = f.length, E = 0; E < h; E++)
                                            "movie" !== f[E].getAttribute("name").toLowerCase() && (d[f[E].getAttribute("name")] = f[E].getAttribute("value"));
                                        s(l, d, n, i)
                                    } else
                                        c(u),
                                        i && i(r);
                        ...
                        i) {
                            var p = o(n);
                            p && typeof p.SetVariable !== P && (r.success = !0,
                            r.ref = p,
                            r.id = p.id),
                            i(r)
                        }
            ...
            function o(e) {
                var t = null
                  , n = m(e);
                return n && "OBJECT" === n.nodeName.toUpperCase() && (t = typeof n.SetVariable !== P ? n : n.getElementsByTagName(D)[0] || n),
                t
            }
            function a() {
            ...
            function s(e, t, n, i) {
                ...
                r) {
                    "OBJECT" === r.nodeName.toUpperCase() ? (N = u(r),
                    I = null) : (N = r,
                    I = n),
                    e.id = M,
                    (typeof e.width === P || !/%$/.test(e.width) && T(e.width) < 310) && (e.width = "310"),
                    (typeof e.height === P || !/%$/.test(e.height) && T(e.height) < 137) && (e.height = "137");
                    ...
                    if (typeof t.flashvars !== P ? t.flashvars += "&" + a : t.flashvars = a,
                    X.ie && 4 !== r.readyState) {
                        var s = _("div");
                        n += "SWFObjectNew",
                        s.setAttribute("id", n),
                    ...
                    if (n) {
                        ...
                        if (i)
                            for (var r = i.length, o = 0; o < r; o++)
                                1 === i[o].nodeType && "PARAM" === i[o].nodeName || 8 === i[o].nodeType || t.appendChild(i[o].cloneNode(!0))
                    }
                }
                return t
            }
            ...
            function d(e, t, n) {
                ...
                if (r) {
                    ...
                    for (s in t)
                        t.hasOwnProperty(s) && "movie" !== s.toLowerCase() && f(c, s, t[s]);
                    X.ie && (c = l(e.data, c.innerHTML));
                    for (o in e)
                        e.hasOwnProperty(o) && (a = o.toLowerCase(),
                        "styleclass" === a ? c.setAttribute("class", e[o]) : "classid" !== a && "data" !== a && c.setAttribute(o, e[o]));
                    X.ie ? H[H.length] = e.id : (c.setAttribute("type", U),
            ...
            function h(e) {
                var t = m(e);
                t && "OBJECT" === t.nodeName.toUpperCase() && (X.ie ? (t.style.display = "none",
                function e() {
                    if (4 === t.readyState) {
                        for (var n in t)
            ...
            function g(e, t, n, i) {
                ...
                if (r) {
                    ...
                    !C || b !== o) {
                        ...
                        C = r.appendChild(a),
                        X.ie && typeof k.styleSheets !== P && k.styleSheets.length > 0 && (C = k.styleSheets[k.styleSheets.length - 1]),
                        b = o
                    }
            ...
            var N, I, R, O, C, b, P = "undefined", D = "object", w = "Shockwave Flash", L = "ShockwaveFlash.ShockwaveFlash", U = "application/x-shockwave-flash", M = "SWFObjectExprInst", x = "onreadystatechange", F = window, k = document, G = navigator, V = !1, Y = [], B = [], H = [], W = [], K = !1, j = !1, z = !0, q = !1, X = function() {
                var e = typeof k.getElementById !== P && typeof k.getElementsByTagName !== P && typeof k.createElement !== P
                  ...
                  , s = [0, 0, 0]
                  , c = null;
                if (typeof G.plugins !== P && typeof G.plugins[w] === D)
                    c = G.plugins[w].description,
                    c && typeof G.mimeTypes !== P && G.mimeTypes[U] && G.mimeTypes[U].enabledPlugin && (V = !0,
                    a = !1,
                    c = c.replace(/^.*\s+(\S+\s+\S+$)/, "$1"),
                    s[0] = T(c.replace(/^(.*)\..*$/, "$1")),
                    s[1] = T(c.replace(/^.*\.(.*)\s.*$/, "$1")),
                    s[2] = /[a-zA-Z]/.test(c) ? T(c.replace(/^.*[a-zA-Z]+(.*)$/, "$1")) : 0);
                else if (typeof F.ActiveXObject !== P)
                    try {
                        var u = new ActiveXObject(L);
                        u && (c = u.GetVariable("$version"),
                        c && (a = !0,
                        c = c.split(" ")[1].split(","),
                        s = [T(c[0]), T(c[1]), T(c[2])]))
                    } catch (e) {}
            ...
            (function() {
                X.w3 && ((typeof k.readyState !== P && ("complete" === k.readyState || "interactive" === k.readyState) || typeof k.readyState === P && (k.getElementsByTagName("body")[0] || k.body)) && t(),
                K || (typeof k.addEventListener !== P && k.addEventListener("DOMContentLoaded", t, !1),
                X.ie && (k.attachEvent(x, function e() {
                    "complete" === k.readyState && (k.detachEvent(x, e),
                    t())
                }),
                F == top && !function e() {
                    if (!K) {
                ...
                X.wk && !function e() {
                    if (!K)
                        return /loaded|complete/.test(k.readyState) ? void t() : void setTimeout(e, 0)
                }()))
            }
            )();
            return Y[0] = function() {
            ...
            }(),
            {
                ...
                embedSWF: function(e, t, i, r, o, c, u, l, f, h) {
                    ...
                    X.w3 && !(X.wk && X.wk < 312) && e && t && i && r && o ? (S(E, !1),
                    n(function() {
                        i += "",
                        r += "";
                        var n = {};
                    ...
                    if (t) {
                        ...
                        for (var n = t.split("&"), i = 0; i < n.length; i++)
                            if (n[i].substring(0, n[i].indexOf("=")) === e)
                                return A(n[i].substring(n[i].indexOf("=") + 1))
                    }
                    return ""
                },
                expressInstallCallback: function() {
                    if (j) {
                        var e = m(M);
                        e && N && (e.parentNode.replaceChild(N, e),
                        I && (S(I, !0),
                        X.ie && (N.style.display = "block")),
                        R && R(O)),
                        j = !1
                    }
                },
    ...
    r = function() {
        ...
        function i(e, t) {
            ...
            void n._immediateFn(function() {
                ...
                if (null === n)
                    return void (1 === e._state ? r : o)(t.promise, e._value);
                var i;
                try {
                    i = n(e._value)
                } catch (e) {
        ...
        n.all = function(e) {
            ...
            return new n(function(e, n) {
                ...
                if (0 === t.length)
                    return e([]);
                for (var r = t.length, o = 0; o < t.length; o++)
                    i(o, t[o])
            }
            )
        }
        ...
        ,
        void 0 === window.Promise && (window.Promise = n),
        window.Promise
    }
    .apply(t, i),
    !(void 0 !== r && (e.exports = r))
